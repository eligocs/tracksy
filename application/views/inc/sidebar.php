 ...
 <div class="page-sidebar-wrapper">
	...
	$role = get_user_role(); ?>
         ...
         <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
             ...
             <!--end leads from Itinerary Genrator-->
             <?php }else{ ?>
             <div class='sidebar_heading'>
                 <span> Leads/Sales </span>
             </div>
             ...
             <li
                 class="nav-item  <?php if( $menu_name == "incentive" ||  $menu_name == "incentive" ){ echo 'active'; }?>">
                 <a href="javascript:;" class="nav-link nav-toggle">
             ...
             <li class="nav-item  <?php if( $menu_name == "vehiclesbooking" ){ echo 'active'; }?> ">
                 ...
                 <ul class="sub-menu">
                     ...
                     <li class="nav-item">
                         <a href="<?php echo site_url("vehiclesbooking/addbookingdetails?type=volvo"); ?>"
                             class="nav-link ">
                             <i class="fa fa-bus" aria-hidden="true"></i>
                     ...
                     <li class="nav-item  ">
                         <a href="<?php echo site_url("vehiclesbooking/addbookingdetails?type=train"); ?>"
                             class="nav-link ">
                     ...
                     <li class="nav-item  ">
                         <a href="<?php echo site_url("vehiclesbooking/addbookingdetails?type=flight"); ?>"
                             class="nav-link ">
             ...
             <li
                 class="nav-item  <?php if( $menu_name == "msg_center" ||  $menu_name == "newsletters" ){ echo 'active'; }?>">
                 <a href="javascript:;" class="nav-link nav-toggle">
                     <i class="fa fa-envelope" aria-hidden="true"></i>
                     <span class="title">Message Center</span>
                     <span class="arrow"></span>
         ...
         <li class="nav-item  <?php if( $menu_name == "payments" ){ echo 'active'; }?>">
             ...
             <ul class="sub-menu">
                 <li class="nav-item  ">
                     <a href="<?php echo site_url("payments"); ?>" class="nav-link ">
                         <i class="fa fa-inr" aria-hidden="true"></i>
                         <span class="title">Itineraries Payments</span><span
                             class="badge badge-info"><?php echo $pending_payment_count; ?></span>
                     </a>
                 </li>
             </ul>
         </li>
