        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js" type="text/javascript"></script>
		        <script src="<?php echo base_url();?>site/assets/js/turn.js" type="text/javascript"></script>
...
<div >
		...
		<div class="hard"> </div>
				...
				echo "<div class='$class'><div class='div_img' ><img src=".base_url('site/images/promotions/').$pid.'/'.$content. "></div></div>";
		
				}
					$i++;  
				} 
				}?>
				<div class="hard" style="background-color:black;"></div>
