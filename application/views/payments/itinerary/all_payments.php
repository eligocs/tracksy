                                ...
                                <div class="col-md-3">
                                    <div class="fillter_box">
                                        ...
                                        <select name="" id="" class="form-control">
                                            ...
                                            <option name="filter" value="pay_received" id="received">Received</option>
                                            <option name="filter" value="complete" id="complete">Complete</option>
                                            <option name="filter" value="refund" id="refund">Refund </option>
                                            <option name="filter" value="travel_date" id="travel_date">TD</option>
                                            <option name="filter" value="pm_ci" id="pm_ci">Closed</option>
                                            <option name="filter" value="pm_oi" id="pm_oi">Open</option>
                                            <option name="filter" title="Pending Payment Confirmation"
