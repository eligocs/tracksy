	...
	<div class="page-content-wrapper">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<a class="btn btn-success" href="<?php echo site_url("hotels/addmealplan"); ?>" title="Add Season">Add Mealplan</a>
			</div>
						...
						<tbody>
							...
							<?php if( !empty($mealplan) ){
								...
								foreach( $mealplan as $meal ){
									echo "<tr><td>{$i}</td>
										<td>{$meal->name}</td>
									<td><a href=" . site_url("hotels/editmealplan/{$meal->id}") . " class='btn btn-success' >Edit</a>";//Show delete button if season greater than four
									if( $i > 4 ){
