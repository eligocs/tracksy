<div class="page-container customer_content">
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<form role="form" id="addHotelRoomRate" action="<?php echo base_url( "hotels/add_room_rates" ); ?>" method="post">
				...
				<style>.single_rate_section{margin-top: 10px; }</style>
				...
				<div class="mt-repeater-rates">
					<div data-repeater-list="hotel_rates_meta">
						...
						<div class="row single_rate_section">
							...
							<div class="mt-innerrepeater-hotel inner_hotel_repeater col-md-8">
									...
									<div data-repeater-item class="mt-innerrepeater-hotel-item" >
										<div class="col-md-3 mt-innerrepeater-hotel-input">				
											<div class="form-group">
												...
												<?php }else{ ?>
													<input type="text" required readonly class="form-control" placeholder="You need to add season to proceed." value="">
													<a href="<?php echo base_url("hotels/addseason"); ?>" title="Add Season">Click here to add season</a>
												<?php } ?>
											</div>
										</div>
										...
										<div class="col-md-3 mt-innerrepeater-hotel-input">
											<div class="form-group">
												...
												<input type="number" required placeholder="Room Rate" maxlength="10" minlength="2" name="room_rates" class="form-control price_input" value=""/> 
											</div>
										</div>
										...
										<div class="col-md-3 mt-innerrepeater-hotel-input">
											<div class="form-group">
												...
												<input type="number" required name="extra_bed_rate" maxlength="10" minlength="2" placeholder="Extra Bed Charges" class="form-control price_input" value=""/> 
											</div>
										</div>
										
										<div class="col-md-3 mt-innerrepeater-hotel-input">
											<div class="form-group">
												<label class="control-label" >Extra Bed Rates (For Children)</label>
												<input type="number" required name="extra_bed_rate_child" maxlength="10" minlength="2" placeholder="Extra Bed Charges for children" class="form-control price_input" value=""/> 
											</div>
										</div>
							...
							<div class="col-md-1">
							<a href="javascript:;" data-repeater-delete class="btn btn-danger mt-repeater-rates-delete mt-repeater-del-left mt-repeater-btn-inline">
				...
				<div class="col-md-4">				
					<div class="form-group">
						<label class="control-label">Room Category*</label>
						<select name="room_cat_id" class="form-control roomcat">
							<option value="">Choose Room Category</option>
							<?php $roomcat = get_room_categories();
							if($roomcat){
								foreach( $roomcat as $rcat ){
				...
				<div class="col-md-4">				
					<div class="form-group">
						...
						<?php $seasons = get_all_seasons();
						if($seasons){ ?>
							<select disabled name="season_id" class="form-control">
								<option value="">Choose Season Type</option>
									<?php foreach( $seasons as $season ){
										echo '<option value="'. $season->id . '">' . $season->season_name . '</option>';
									} ?>
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label" >Extra Bed Rates*</label>
						<input type="number" name="extra_bed_rate" maxlength="10" minlength="2" placeholder="Extra Bed Charges" class="form-control price_input" value=""/> 
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label" >Extra Bed Rates (For Children)</label>
						<input type="number" name="extra_bed_rate" maxlength="10" minlength="2" placeholder="Extra Bed Charges for children" class="form-control price_input" value=""/> 
					</div>
				</div>
				--> */ ?>
