        ...
        <div class="page-content">
            <div class="portlet box blue">
                <div class="portlet-title">
                    ...
                    <a class="btn btn-success" href="<?php echo site_url("hotels/viewroomcategory"); ?>"
                        title="Back">Back</a>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Room Category" name="room_cat_name" class="form-control"
                                    value="" />
                            </div>
                        </div>
                ...
                success: function(res) {
                    if (res.status == true) {
                        ...
                        window.location.href =
                            "<?php echo site_url("hotels/viewroomcategory");?>";
                    } else {
                        resp.html(
