					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" required placeholder="Season Name. eg: Mid Season etc." name="inp[season_name]" class="form-control" value="<?php echo $season->season_name; ?>"/> 
							</div>
						</div>
...
jQuery(document).ready(function($){
	...
	$(document).on("click", ".season_to", function(){
		...
		$(this).datepicker({	
			...
			var nextFromInput = $(this).closest(".mt-repeater-item").next(".mt-repeater-item").find(".season_from");
