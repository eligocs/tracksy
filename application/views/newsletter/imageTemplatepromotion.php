...
<body class="status">
<?php  if($image){ 	$temp = $image[0]; 
  ?><div class="content">
		<div class="container">
			<div class="page-content">
				<div class="logo text-center"><a href="https://www.trackitinerary.com/"><img src="<?php echo site_url() ?>site/images/trackv2-logo.png" alt="Track Itinerary Software></a></div>
