	...
	<div class="page-content-wrapper">
		...
		<div class="portlet box blue">
				...
				<div class="portlet-title">
					...
					<a class="btn btn-success pull-right" href="<?php echo site_url("newsletters/send"); ?>" title="Back">Back</a>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
			...
			<form role="form" class="form-horizontal form-bordered" method="post" action="<?php echo base_url('newsletters/send'); ?>" id="sendNewsletter">
