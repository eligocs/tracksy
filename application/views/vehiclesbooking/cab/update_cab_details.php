	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="col-md-4">
					...
					<input type="text" disabled required class="form-control" value="<?php echo isset($cab_booking->total_travellers) ? $cab_booking->total_travellers : ""; ?>">
				</div>
			</div>
				...
				<div class="col-md-4">
					<div class="form-group2">
						...
						<div class="input-group input-daterange">
							<input disabled required type="text" class="form-control" value="<?php echo isset($cab_booking->picking_date) ? $cab_booking->picking_date : ""; ?>" id="check_in" >
							<span class="input-group-addon hotel_addon"> to </span>
							<input disabled required type="text" class="form-control" value="<?php echo isset($cab_booking->droping_date) ? $cab_booking->droping_date : ""; ?>" id="check_out" > 
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group input-large">
						...
						<input disabled type="text" class="form-control timepicker timepicker-no-seconds" value="<?php echo isset($cab_booking->reporting_time) ? $cab_booking->reporting_time : ""; ?>"/>
						<span class="input-group-addon"> Dep.</span>
						<input disabled type="text" class="form-control timepicker timepicker-no-seconds" value="<?php echo isset($cab_booking->departure_time) ? $cab_booking->departure_time : ""; ?>"/>
					</div>
				</div>
				</div>
				<div class="col-md-4">
					<div class="form-group2">
						...
						<input type="text" readonly required  id="booking_duration" class="form-control" value="<?php echo isset($cab_booking->booking_duration) ? $cab_booking->booking_duration : ""; ?>">
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="col-md-4">
					...
					<input type="text" disabled required  id="pic_location" placeholder="Picking Location" class="form-control" value="<?php echo isset($cab_booking->pic_location) ? $cab_booking->pic_location : ""; ?>">
				</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group2">
						...
						<input type="text" required disabled id="drop_location" placeholder="Droping Location" class="form-control" value="<?php echo isset($cab_booking->drop_location) ? $cab_booking->drop_location : "";?>">
					</div>
				</div>
				...
				<div class="form-group2">
					...
					<input required disabled type="text" placeholder="Cab Rate" class="form-control cab_rate clearfield" value="<?php echo isset($cab_booking->cab_rate) ? $cab_booking->cab_rate : 0; ?>"/>
				</div> 
				</div>
				...
				<div class="form-group2">
					<label class=" "><strong>Inclusion Charges:</strong></label>
					 <input class="form-control" disabled id="extra_charges" type="text" placeholder="eg. 100" value="<?php echo isset($cab_booking->extra_charges) ? $cab_booking->extra_charges : 0; ?>">
				</div>	 
				</div>
				<div class="col-md-4">
