		...
		<!--Show success message if hotel edit/add -->
			...
			<?php if($tra_booking){ ?>
				...
				<?php if( $tra_booking->booking_status == 9 ){ ?>
					<div class="close_iti text-center">
						<p class="text-center"><strong class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Booking Approved</strong></p>
				...
				<?php }elseif( $tra_booking->booking_status == 8 ){
					...
					echo '<p class="text-center"><strong class="btn btn-info"><i class="fa fa-spinner" aria-hidden="true"></i> Booking Processing</strong></p>'; ?>
					<!--Cancel BOOKING -->
					<?php if( $role == 99 || $role == 98 || $role == 97  ){ ?>
			...
			<?php if( $tra_booking->booking_status != 8 ){ ?>
				<div class="text-center">
					<a title='Edit booking' href="<?php echo site_url("vehiclesbooking/editvtf/{$tra_booking->id}/{$tra_booking->iti_id}"); ?>" class="" ><i class="fa fa-pencil"></i> Edit Booking</a>
				</div>	
			<?php } ?>
		<div class="well">
			<?php
