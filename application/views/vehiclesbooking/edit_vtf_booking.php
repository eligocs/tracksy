		...
		<div class="page-content">
			...
			<div class="col-md-4">
				<div class="form-group2">
					<label class=""><?php echo $t_name; ?>*: </label> <!-- eg. Bus Name-->
						<input type="text" data-toggle="tooltip" placeholder="<?php echo $t_name; ?>" title="<?php echo $t_name_placeholder;?>" name="inp[t_name]" class="form-control" value="<?php if( isset($tra_book->t_name) ){ echo $tra_book->t_name; } ?>"/>
				</div>
			</div>
			<div class="col-md-4">
					<div class="form-group2">
						<label class=" "><?php echo $t_number;?> *:</label>
						<input type="text" data-toggle="tooltip" placeholder="<?php $t_number; ?>" title="<?php echo $t_number_placeholder; ?>" name="inp[t_number]" class="form-control" value="<?php if( isset($tra_book->t_number) ){ echo $tra_book->t_number; } ?>"/>
					</div> 
				</div>
			...
			<div class="col-md-4">
				<div class="form-group2">
					...
					<textarea data-toggle="tooltip" placeholder="Seat number" title="Seat Number Seprated by Comma eg. 23,32,2. For Multi transporter use vehicle number eg: HP-63 6564(2,3,4,5), HP-63 6565(2,3,5)" name="inp[seat_numbers]" class="form-control" ><?php if( isset($tra_book->seat_numbers) ){ echo $tra_book->seat_numbers; } ?></textarea>
				</div> 
			</div>
			<div class="clearfix"></div>
			<div class="col-md-6">
				...
				<div class="col-md-3">
					<div class="form-group2">
						...
						<input type='number' required data-toggle="tooltip" placeholder="Cost Per/seat" title="Cost Per Seat" name="inp[cost_per_seat]" class="form-control cost_per_seat" value="<?php if( isset($tra_book->cost_per_seat) ){ echo $tra_book->cost_per_seat; } ?>" >
					</div> 
				</div>
				<div class="clearfix"></div>
				<div class="col-md-3">
					<div class="form-group2">
						...
						<textarea type="text" data-toggle="tooltip" placeholder="Ticket number" title="For Multi transporter use vehicle number eg: HP-63 6564(tick285,tick286,tick286), HP-63 6565(3332,3433,235)" name="inp[ticket_numbers]" class="form-control"><?php if( isset($tra_book->ticket_numbers) ){ echo $tra_book->ticket_numbers; } ?></textarea>
					</div> 
				</div>
				...
				<div id="return" style="display: <?php echo $display; ?>">
					...
					<div class="col-md-3">
						<div class="form-group2">
							...
							<input type="text" data-toggle="tooltip" placeholder="<?php echo $t_number; ?> " title="<?php echo $t_number_placeholder; ?>" name="inp[return_t_number]" class="form-control clearfield" value="<?php if( isset($tra_book->return_t_number) ){ echo $tra_book->return_t_number; } ?>"/>
						</div> 
					</div>	
					<div class="col-md-4">
				<div class="form-group2">
					...
					<div class="form-group2">
						...
						<textarea type="text" data-toggle="tooltip" placeholder="Ticket number" title="(Return Trip) For Multi transporter use vehicle number eg: HP-63 6564(tick285,tick286,tick286), HP-63 6565(3332,3433,235)" name="inp[return_ticket_numbers]" class="form-control clearfield"><?php if( isset($tra_book->return_ticket_numbers) ){ echo $tra_book->return_ticket_numbers; } ?></textarea>
					</div> 
					</div>
					...
					<div class="col-md-4">
						<div class="form-group2">
							...
							<input required type='number' data-toggle="tooltip" placeholder="Cost Per/seat (Return trip)" title="Cost Per Seat" name="inp[cost_per_seat_return_trip]" class="form-control cost_per_seat_return_trip clearfield" value="<?php if( isset($tra_book->cost_per_seat_return_trip) ){ echo $tra_book->cost_per_seat_return_trip; } ?>">
						</div> 
					</div>
					<div class="col-md-4">
						<div class="form-group2">
