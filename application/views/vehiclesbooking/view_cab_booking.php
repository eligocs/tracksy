			...
			<?php if($cab_booking){ ?>
				...
				<div class="well well-sm text-center">
					...
					<?php if($cab_booking->booking_status == 9 ){ ?>
						...
						<div class="close_iti">
							<a href="javascript: void(0)" id="update_closeStatus" data-id = "<?php echo $cab_booking->id; ?>" class="btn btn-danger" title="click to Cancel Booking"><i class="fa fa-window-close" aria-hidden="true"></i> Cancel Booking</a>	
						</div>
					...
					<?php }else{ ?>
						...
						<!--Cancel BOOKING -->
						<div class="">
							<a href="javascript: void(0)" id="cancle_pre_booking" data-id = "<?php echo $cab_booking->id; ?>" class="btn btn-danger" title="click to Cancel Booking"><i class="fa fa-window-close" aria-hidden="true"></i> Cancel Booking</a>	
						</div>
					<?php } ?>
