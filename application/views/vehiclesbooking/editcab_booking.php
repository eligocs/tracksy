		...
		<div class="page-content">
			...
			<div class="col-md-4">
				...
				<div class="form-group2">
					...
					<input readonly required type="text" placeholder="Cab Rate" name="inp[cab_rate]" class="form-control cab_rate clearfield" value="<?php echo isset($cab_booking->cab_rate) ? $cab_booking->cab_rate : 0; ?>"/>
				</div> 
				</div>
