	...
	<div class="page-content-wrapper">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<a class="btn btn-success" href="<?php echo site_url("itineraries"); ?>" title="Book Vehicle">Book Volvo/Train/Flight</a>
			</div>
		</div>
			<div class="row marginBottom second_custom_card">
				...
				<form id="form-filter" class="form-horizontal marginRight">
					<div class="actions custom_filter pull-right">
						...
						<select class="form-control2 booking_type" name="booking_type">
...
jQuery(document).ready(function($){
	$(document).on("click",".ajax_delete_booking",function(){
		...
		if (confirm("Are you sure?")) {
			$.ajax({
				url: "<?php echo base_url(); ?>" + "AjaxRequest/ajax_delete_veh_booking?id=" + id,
				type:"GET",
				data:id,
				dataType: 'json',
				cache: false,
