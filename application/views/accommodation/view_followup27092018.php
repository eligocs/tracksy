				...
				<div class="portlet box blue">
					<div class="portlet-title">
						...
						<?php if( is_admin_or_manager() ){ ?>
							<strong class=''>Customer Type: </strong> <span class='mehroon'><?php echo $cus_type; ?></span> <?php echo $ref_name . $ref_contact; ?>
						<?php } ?>
						</div>
					...
					<?php if( $iti->iti_status == 0 && $iti->email_count > 0 && $iti->publish_status == "publish" && $user_role != 97 ){ ?>
						...
						<div class="call_log" id="call_log_section">
							<form id="call_detais_form">
								...
								<input type="hidden" id="hid_iti_id" name="iti_id" value="<?php echo $iti->iti_id; ?>">
								<input type="hidden" id="hid_temp_key" name="temp_key" value="<?php echo $iti->temp_key; ?>">
