...
<div class="page-container itinerary-view">
    <div class="page-content-wrapper">
            ...
            <div id="update_iti_hold_status">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <a href="<?php echo $doc_path . $doc->file_url; ?>" target="_blank"
                                    class="btn btn-success" style="position:relative;">
                    ...
                    <form id="frmappOnholditi">
                        <div class="frm_section">
                            ...
                            <div class='form-group col-md-12'>
                                <p class="text-center uppercase"><strong style="font-size: 22px;">Please View And Update
                                        Itinerary: </strong></p>
                            </div>
                            <div class='form-group col-md-12 iti_info'>
                                <p class="text-center">
                                    <strong> Final Cost: </strong><?php echo iti_final_cost($iti->iti_id); ?>
                                    <strong> Advance Recived: </strong><?php echo $pay_detail->advance_recieved; ?>
                                    <strong> Balance: </strong> <?php echo $pay_detail->total_balance_amount; ?><strong>
                                        Booking Date: </strong>
                                    <?php echo !empty( $pay_detail->booking_date ) ? display_month_name( $pay_detail->booking_date ) : ""; ?><strong>
                                        Package Category: </strong><?php echo $iti->approved_package_category; ?>
                                </p>
                            </div>
                            ...
                            <div class="form-group col-md-3 remove_required">
                                <div class="form-group2">
                                    ...
                                    <input class="form-control" <?php echo $aadhar_card_req; ?> id="client_aadhar_card"
                            ...
                            <div class="form-group col-md-3 remove_required">
                                <div class="form-group2">
                                    ...
                                    <input class="form-control" <?php echo $payment_screenshot_req; ?>
                                        id="payment_screenshot" type="file" name="payment_screenshot">
                                </div>
                                <img id="payment_screenshot_priview" style="display: none;" width="100" height="100" />
                            </div>
                            <!--end perperson rate meta -->
                            <div class='form-group col-md-3'>
                                <label><strong>Comments*</strong><span class="red" style="font-size: 12px;"> Note: This
                                        comment is also visible for agent.</span></label>
                                <textarea required name="approved_note" placeholder="APPROVED NOTE"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select required name="package_type_iti" class="form-control">
                                    ...
                                    <option
                                        <?php echo isset($pay_detail->iti_package_type) && $pay_detail->iti_package_type == "Honeymoon Package" ? 'selected' : '' ?>
                                        value="Honeymoon Package">Honeymoon Package</option>
                                    <option
                                        <?php echo isset($pay_detail->iti_package_type) && $pay_detail->iti_package_type == "Fixed Departure" ? 'selected' : '' ?>
                                        value="Fixed Departure">Fixed Departure</option>
                                    <option
                                        <?php echo isset($pay_detail->iti_package_type) && $pay_detail->iti_package_type == "Group Package" ? 'selected' : '' ?>
                                        value="Group Package">Group Package</option>
                                    <option
                                        <?php echo isset($pay_detail->iti_package_type) && $pay_detail->iti_package_type == "Other" ? 'selected' : '' ?>
                            ...
                            <div class="col-md-12 other_docs">
                                <a href="javascript:;" id="add_other_docs_btn"
                                    ...
                                    style="font-size: 12px;"> Please upload only ( jpg|jpeg|png|pdf ) files and not more
                                    than 2MB.</span>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <a href="javascript: void(0);" class="btn btn-danger del_client_docs"
                        ...
                        <div class='form-group col-md-3'>
                            <div class="button_sec" style="margin-top: 30px;">
                                ...
                                <button type="button" class="btn red reject_iti_btn" data-toggle="modal"
                                    data-target="#reject_iti_ModalS"> Reject</button>
                            </div>
                        </div>
                                    ...
                                    <form id="frm_rej_iti_manager">
                                        <div class="form-group">
                                            <label class="radio-inline">
                                                <input type="radio" required name="reject_due_to" value="2">Due to
                                                Payment
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" required name="reject_due_to" value="3">Due to
                                                Itinerary
                                            </label>
                                        </div>
                                        <div class="form-group">
                                            <div class="checkbox">
                                                ...
                                                <textarea required="required" name="reject_note"
                                                    placeholder="Write a comment for agent why itinerary rejected..."
                                                    class="form-control" rows="3"></textarea>
                                            </div>
                                        </div>
                                        <button type="submit" id="reqDis_rej_app" name="action_reject"
                                            class="btn btn-success">Submit To Reject</button>
                ...
                <form id="frm_update_booking_status_agent">
                    ...
                    <div class="frm_section">
                        ...
                        <div class='form-group col-md-12 iti_info'>
                            <p class="text-center"><strong> Advance Recived:
                                </strong><?php echo $pay_detail->advance_recieved; ?> <strong> Balance: </strong>
                                <?php echo $pay_detail->total_balance_amount; ?><strong> Booking Date: </strong>
                                <?php echo !empty( $pay_detail->booking_date ) ? display_month_name( $pay_detail->booking_date ) : ""; ?><strong>
                                    Package Category: </strong><?php echo $iti->approved_package_category; ?>
                            </p>
                        </div>
                        <div class="booking_section" style="display:block;">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input required readonly="readonly" data-date-format="yyyy-mm-dd"
                                    class="input-group form-control" id="booking_date" type="text"
                                    value="<?php echo isset( $pay_detail->booking_date ) ? $pay_detail->booking_date : ""; ?>"
                                    name="booking_date" />
                            </div>
                            ...
                            <?php /*
													<div class="form-group col-md-2">
														...
														<input type="number" required class="form-control" data-tax="<?php echo $tax; ?>" id="fnl_amount"
                            placeholder="Total Package Cost" value="<?php echo $f_amount; ?>" />
                        </div>
                        <?php 
													...
													?>
                        <div class="form-group col-md-2">
                            <label for="usr">Add GST <span style="color:red;"> (<?php echo $tax; ?>%
                                    Extra)</span>:</label>
                            <input <?php echo $is_gst ? "checked" : ""; ?>
                                title="Check/Uncheck this button to add/substract 5% extra GST with package cost"
                                type="checkbox" name="is_gst" id="tx" class="form-control" />
                        </div>
                        */ ?>
                        <div class="form-group col-md-3">
                            <label for="usr">Total Package Cost<span style="color:red;"> *</span>:</label>
                            <input type="number" readonly required class="form-control" id="fnl_amount_tax"
                                title="Total package cost after inc. tax"
                                placeholder="Total package cost after inc. tax" value="<?php echo $total_pack_cost; ?>"
                                name="final_amount">
                        </div>
                        ...
                        <div id="due_payment_section">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" required id="next_pay_balance" data-date-format="yyyy-mm-dd"
                                    name="next_payment_bal" placeholder="Second Payment Balance" class="form-control"
                                    value="<?php echo $second_payment_bal; ?>">
                            </div>

                            <div class="form-group col-md-6">
                                <label class=""><strong>Second Installment Due Date:</strong></label>
                                <input data-date-format="yyyy-mm-dd" class="input-group form-control date_picker"
                                    id="next_payment_date" readonly type="text"
                                    value="<?php echo $second_payment_date; ?>" name="next_payment_date" />
                            </div>

                            <div class="form-group col-md-6">
                                <label class=""><strong>3rd Installment Amount:</strong><span
                                        id="pendingBal"></span></label>
                                <input type="number" readonly id="third_payment_bal" name="third_payment_bal"
                                    placeholder="Third Payment Amount" class="form-control"
                                    value="<?php echo $third_payment_bal; ?>">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input readonly="readonly" data-date-format="yyyy-mm-dd"
                                    ...
                                    id="third_payment_date" type="text" value="<?php echo $third_payment_date; ?>"
                                    name="third_payment_date" />
                            </div>

                            <div class="form-group col-md-6">
                                <label class=""><strong>Final Installment:</strong></label>
                                <input type="number" readonly id="final_payment_bal" name="final_payment_bal"
                                    placeholder="Final Installment Amount" class="form-control"
                                    value="<?php echo $final_payment_bal; ?>">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input readonly="readonly" data-date-format="yyyy-mm-dd"
                                    class="input-group form-control date_picker_validation date_picker"
                                    id="final_payment_date" type="text" value="<?php echo $final_payment_date; ?>"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" required readonly id="balance_pay" name="total_balance" placeholder=""
                                class="form-control" value="<?php echo $total_balance_amount; ?>">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-group2">
                                <label class=" "><strong>Client Aadhar Card:</strong></label>
                                <input <?php echo $aadhar_card_req; ?> class="form-control" id="client_aadhar_card"
                                    type="file" name="client_aadhar_card">
                            </div>
                            <img id="client_aadhar_card_priview"
                                src="<?php echo $doc_path . $pay_detail->client_aadhar_card; ?>" style="display: block;"
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-group2">
                                <label class=" "><strong>Payment Screenshot*:</strong></label>
                                <input <?php echo $payment_screenshot_req; ?> class="form-control"
                                    id="payment_screenshot" type="file" name="payment_screenshot">
                            </div>
                            <img id="payment_screenshot_priview"
                                src="<?php echo $doc_path . $pay_detail->payment_screenshot; ?>" style="display: block;"
                                width="100" height="100" />
                        </div>
                    </div>
                    <!--booking section-->
                    ...
                    <p class="text-center">to change itinerary
                        <a title='Edit Itinerary' target="_blank"
                            href="<?php echo site_url("itineraries/edit/{$iti->iti_id}/{$iti->temp_key}"); ?> "
                            class='btn btn-success'><i class='fa fa-pencil' aria-hidden='true'></i> Edit Itinerary</a>
                    </p>
                    <div class="form-group col-md-6">
                        <label for="usr">Please Enter Approval Note:<span style="color:red;"> *</span>:</label>
                        <textarea required class="form-control" placeholder="Please Enter Approval Note"
        ...
        <!-- Rejected Reason -->
        <div class="padding_zero text-center well well-sm">
            <h2 class="red margin_zero">Rejected Itinerary</h2>
        ...
        <div class="row" id="update_rates_section">
            <form id="submitRates">
                ...
                <div class="col-md-12 perperson_section" style="display: none;">
                    ...
                    <div class='super_deluxe form-group col-md-3'>
                        <label><strong class="red">Luxury (Per/child):</strong><span
                                style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
                        <input <?php echo $sd_req; ?> name="per_person_ratemeta[child_super_deluxe_rates]" type="number"
                            class='form-control' placeholder="Luxury Per/child Cost"></input>
                    </div>
                    <div class='luxury form-group col-md-3'>
                ...
                <div class='form-group col-md-8'>
                    <div class="button_sec" style="margin-top: 30px;">
                        <button name="action" class="btn green button-submit" type="submit" value="agent">Send To
                            Agent</button> <strong class="red"> OR </strong>
                        <!--if team leader request to manager else req to supermanager -->
                        <?php if( is_teamleader() ){ ?>
                        <button name="action" class="btn green button-submit" type="submit" value="manager">Send To
                            Manager</button> <strong class="red"> OR </strong>
                        <?php }else{ ?>
                        <button name="action" class="btn green button-submit" type="submit" value="supermanager">Send To
                            Admin/Super Manager</button> <strong class="red"> OR </strong>
                        <?php } ?>
                        <button type="button" class="btn red reject_iti_btn" data-toggle="modal"
                    ...
                    <div class="modal-body">
                        <form id="frm_rejectItinerary">
                            <div class="form-group">
                                <div class="checkbox">
                                    <label for="email">Reject Comment*</label><br>
                                    <textarea required="required" name="iti_reject_comment"
                                        placeholder="Write a comment for agent why itinerary rejected..."
                                        class="form-control" rows="3"></textarea>
                                </div>
                            </div>
        ...
        <div class="row" id="update_rates_section">
            <form id="update_price_supermanager">
                ...
                <div class='standard  form-group col-md-2'>
                    <label><strong>Deluxe:</strong></label>
                    <input <?php echo $st_req; ?> name="rate_meta[standard_rates]" type="number" class='form-control'
                ...
                <div class="col-md-12 perperson_section"
                    ...
                    <div class='standard  form-group col-md-3'>
                        ...
                        <input <?php echo $st_req; ?> name="per_person_ratemeta[child_standard_rates]" type="number"
                            ...
                            value="<?php echo $child_s_pp; ?>"></input>
                    </div>
                    ...
                    <div class='super_deluxe form-group col-md-3'>
                        <label><strong class="red">Luxury (Per/child):</strong><span
                                style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
                        <input <?php echo $sd_req; ?> name="per_person_ratemeta[child_super_deluxe_rates]" type="number"
                            class='form-control' placeholder="Luxury Per/child Cost"
                    ...
                    <div class='luxury form-group col-md-3'>
                        ...
                        <input <?php echo $l_req; ?> name="per_person_ratemeta[child_luxury_rates]" type="number"
                            class='form-control' placeholder="Super Deluxe Per/child Cost"
                            value="<?php echo $child_l_pp; ?>"></input>
                    </div>
                </div>
                <!--end perperson rate meta -->
                <div class="clearfix"></div>
                <div class='luxury form-group col-md-4'>
                    ...
                    <textarea required name="rate_comment"
                        class='form-control'><?php echo $iti->rate_comment; ?></textarea>
                </div>
        ...
        <div class="row" id="update_rates_section">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    <thead class="thead-default">
                        <tr>
                            <p class="text-center"><strong style="color: red; font-size: 22px;">Old Price</strong></p>
                        </tr>
                        <tr>
                            <th> Deluxe</th>
                            <th> Super Deluxe</th>
            ...
            <form id="frmDiscountRates">
                ...
                <div class='form-group col-md-12'>
                    <p class="text-center"><strong style="font-size: 22px; color: green;">Please Update Rates By Hotel
                            Category : </strong>(DISCOUNT)</p>
                </div>
                ...
                <div class='update_margin_discount' style="display: none;">
                    <div class='standard  form-group col-md-6'>
                        ...
                        <textarea style='display:none;'
                            name='last_per_person_ratemeta'><?php echo $last_person_ratemeta; ?></textarea>
                    </div>
                </div>
                ...
                <div class='update_price_customprice' style="display: none;">
                    ...
                    <div class='super_deluxe form-group col-md-2'>
                        <label><strong>Super Deluxe:</strong></label>
                        <input <?php echo $sd_req; ?> name="super_deluxe_rates" type="number"
                            class='form-control'></input>
                    </div>
                    <div class='luxury form-group col-md-2'>
                        <label><strong>Luxury:</strong></label>
                ...
                <div class='form-group col-md-4'>
                    ...
                    <button name="action" title="Direct Update" class="btn green button-submit" type="submit"
                        value="agent">Update</button>
                    <?php if( !is_super_manager() ){ ?>
                    <strong class="red"> OR </strong>
                    <?php if( is_teamleader() ){ ?>
                    <button name="action" class="btn green button-submit" type="submit" value="manager">Send To Manager
                        <?php }else{ ?>
                        <button name="action" title="Sent rates to supermanager for verfiy"
                            class="btn green button-submit" type="submit" value="supermanager">Send To Admin/Super
                            Manager</button>
                        <?php } ?>
                        <?php } ?>
                </div>
        ...
        <form id="frmDiscountSupermanager">
            <div class='form-group col-md-12'>
                <p class="text-center"><strong style="font-size: 22px; color: green;">Please Approve/Update Rates By
                        Hotel Category: </strong></p>
            </div>
            ...
            <div class="col-md-12 perperson_section"
                ...
                <div class='standard  form-group col-md-3'>
                    ...
                    <input name="per_person_ratemeta[standard_rates]" value="<?php echo $s_pp; ?>" type="number"
                        <?php if( empty( $stand_r ) ){ echo "readonly"; }else{ echo "required"; } ?>
                        class='form-control' placeholder="Deluxe Per/Person Cost"></input>
                </div>
                ...
                <div class='deluxe form-group col-md-3'>
                    ...
                    <input name="per_person_ratemeta[deluxe_rates]" value="<?php echo $d_pp; ?>" type="number"
                        <?php if( empty( $del_r ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control'
                        placeholder="Super Deluxe Per/Person Cost"></input>
                </div>
                <div class='super_deluxe form-group col-md-3'>
                    <label><strong>Luxury (Per/Person):</strong></label>
                    <input name="per_person_ratemeta[super_deluxe_rates]" value="<?php echo $sd_pp; ?>" type="number"
                        <?php if( empty( $sdelux_r ) ){ echo "readonly"; }else{ echo "required"; } ?>
                        class='form-control' placeholder="Luxury Per/Person Cost"></input>
                </div>
                <div class='luxury form-group col-md-3'>
                    <label><strong>Super Luxury (Per/Person):</strong></label>
                    <input name="per_person_ratemeta[luxury_rates]" type="number"
                        <?php if( empty( $lux_r ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control'
                        value="<?php echo $l_pp; ?>" placeholder="Super Deluxe Per/Person Cost"></input>
                </div>
                ...
                <!--child rate-->
                <div class='standard  form-group col-md-3'>
                    <label><strong class="red">Deluxe (Per/child):</strong><span style="font-size:10px; color: red;"> (
                            Leave empty if not exists)</span></label>
                    <input <?php echo $st_req; ?> name="per_person_ratemeta[child_standard_rates]" type="number"
                        class='form-control' placeholder="Deluxe Per/child Cost"
                        value="<?php echo $child_s_pp; ?>"></input>
                </div>
            ...
            <div class="clearfix"></div>
            <div class='luxury form-group col-md-4'>
                <label><strong>Rate Comments*</strong><span class="red" style="font-size: 12px;"> Note: This comment is
                        also visible for client.</span></label>
                <textarea required name="rate_comment" class='form-control'></textarea>
            </div>
        ...
        <?php } ?>
        <!-- ENd price updated by supermanager -->
        ...
        <div class="row2">
                        ...
                        <tbody>
                            ...
                            <tr class="">
                                <td width="33%"><strong>INR
                                        <?php echo $paymentDetails[0]->total_package_cost; ?>/-</strong></td>
            ...
            <p class="text-center">
                ...
                <a class="btn btn-success" data-iti_id="<?php echo $iti->iti_id; ?>"
                    data-temp_key="<?php echo $iti->temp_key; ?>" href="#" data-agent_id="<?php echo $iti->agent_id; ?>"
                    id="send_price_request" title="Sent Price request for manager">Sent Price Request To Manager</a>
            ...
            <div class="form-group col-md-12">
                ...
                <a title='Edit' href=" <?php echo site_url("itineraries/edit/{$iti->iti_id}/{$iti->temp_key}") ; ?> "
                ...
                <span class="btn btn-green reqPrice_update" title="Request For Update Price">Request Manager To Update
                    Price</span>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="reqPriceForm">
                                    ...
                                    <input type="hidden" name="temp_key" value="<?php echo $iti->temp_key; ?>">
                                    <input type="hidden" name="agent_id" value="<?php echo $iti->agent_id; ?>">
                                    <button type="submit" id="reqDis_btn" class="btn btn-default green">Sent
                                        Request</button>
                                                ...
                                                <thead class="thead-default">
                                                    <tr>
                                                        <p class="text-center"><strong
                                                                style="color: red; font-size: 22px;">Price</strong></p>
                                                    </tr>
                                                    <tr>
                                                        <th> Deluxe</th>
                                                        <th> Super Deluxe</th>
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on("submit", '#frm_update_booking_status_agent', function(event) {
            ...
            ajaxReq = $.ajax({
                ...
                error: function(e) {
                    ...
                    $("#submit_frm").removeAttr("disabled");
                    resp.html(
                        '<div class="alert alert-danger"><strong>Error! </strong>Please reload page and try again.</div>'
                    );
                    //console.log(e);
                }
            });
        ...
        $(document).on("blur", "#next_pay_balance", function() {
            ...
            if (_this_val > pending) {
                swal("Warning!", "Next Payment should be less than or equal Pending amount = " +
                    pending, "warning");
                $(".resPonse").html(
            ...
            var removeAt = _this_val >= pending ? thrPay.attr("readonly", "readonly") : thrPay
                .removeAttr("readonly");
        ...
        $(document).on("blur", "#third_payment_bal", function() {
            ...
            var addAtt = finalAmount >= 1 ? fDat.attr("required", "required") : fDat.removeAttr(
                "required");
        });
    });
    </script>
        ...
        $("#frm_rej_iti_manager").validate({
            submitHandler: function(form) {
                ...
                ajaxReq = $.ajax({
                    ...
                    beforeSend: function() {
                        resp.html(
                            "<div class='alert alert-info'><strong>Please wait</strong> sending.....</div>"
                        );
                    },
                    success: function(res) {
                        if (res.status == true) {
        ...
        $(document).on("submit", '#frmappOnholditi', function(event) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    console.log(res);
                    resp.html(
                        '<div class="alert alert-success"><i class="fa fa-spinner fa-spin"></i> ' +
                        res.msg + '</div>');
                    location.reload();
                },
                error: function(e) {
            ...
            submitHandler: function(form) {
                ...
                if (confirm("Are you sure ? ")) {
                    ajaxReq = $.ajax({
                        ...
                        beforeSend: function() {
                            resp.html(
                                "<div class='alert alert-info'><strong>Please wait</strong> Please wait request sending to manager....</div>"
                            );
                        },
                        success: function(res) {
                            if (res.status == true) {
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status == true) {
                            resp.html(
                                '<div class="alert alert-success"><strong>Redirecting.....</strong></div>'
                            );
                            //console.log("done");
        ...
        $("#submitRates").validate({
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        resp.html(
                            '<p class="alert alert-success"><i class="fa fa-spinner fa-spin"></i> Please wait...</p>'
                        );
                    },
                    success: function(res) {
                        if (res.status == true) {
