                ...
                <ul class="nav nav-tabs" id="tab_lising" role="tablist">
                  ...
                  <div class="tab-content client-view">
					...
					<p><strong class="clrblue">Hi, <?php echo $customer_name; ?></strong> </p>
						<p><strong class="clrblue">GREETINGS FROM  Track Iinerary </strong></p>
					...
					*/				
						...
						//Rate meta
						$rate_meta = !empty( $acc->rates_meta ) ? unserialize($acc->rates_meta) : "";
									...
									<div class="tab-content">
										...
										<div class="tab-pane fade <?php echo $st_li_active; ?>" id="standard_tab">
												...
												echo "<table class='table table-bordered'>
													...
													<?php /*
													echo "<table class='table table-bordered price_table'>
					...
					<div class="well well-sm"><h3><?php echo !empty( $acc->final_amount ) ? "Final Cost: <strong class='green'> " . number_format($acc->final_amount) . " /-</strong>" : "Rates"; ?></h3></div>
					...
					<div class="cart">
						<div class="row">
							<div class="text-right">
								...
								<!--a class="btn" href="<?php //echo site_url("promotion/pdf/{$acc->iti_id}/{$acc->temp_key}"); ?>" title="Download Pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a-->
