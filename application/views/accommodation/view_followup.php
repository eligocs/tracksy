...
<div class="page-container itinerary-view view_call_info">
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- Rejected Reason -->
            <div class="well well-sm text-center margin_zero padding_zero">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body ">
                    <div class="table-responsive">
                        ...
                        <p style="font-size:12px; color: red;"><strong>Note: </strong>If you confirm hotel booking you
                            can't able to create new booking against this itinerary..You can't confirm booking if
            ...
            */ ?>
            ...
            <div class="inquery_section custom_card">
                ...
                <p style="margin-bottom:0;" class="alert alert-danger"><strong>Note: </strong>You can only take the
            ...
            <div class="call_log" id="call_log_section">
                <form id="call_detais_form" enctype="multipart/form-data">
                    <div class="call_type_seciton">
                        ...
                        <label class="radio-inline" style="display: <?php echo $book_status == 3 ? "none" : ""; ?>">
                            <input class="radio_toggle" data-id="call_not_picked_panel" required id="call_not_picked"
                                type="radio" name="callType" value="Call not picked">Call not picked</label>
                        <label class="radio-inline" style="display: <?php echo $book_status == 3 ? "none" : ""; ?>">
                            <input class="radio_toggle" data-id="close_lead_panel" required id="close_lead" type="radio"
                                name="callType" value="Close lead">Decline Itinerary</label>
                            ...
                            <div class="booking_section" style="display:none;">
                                ...
                                <div class="frm_section">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input required type="number" id="pack_advance_recieve" name="advance_recieve"
                                            placeholder="Advance Received. eg: 5000" class="form-control" value="">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6" id="ttravel_date">
                                        ...
                                        <input readonly="readonly" required data-date-format="yyyy-mm-dd"
                                            class="input-group form-control date_picker" id="travel_date" type="text"
                                            value="" name="travel_date" />
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group2">
                                            <label class=" "><strong>Client Aadhar Card:</strong> <span class="red">(Max
