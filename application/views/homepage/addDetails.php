									...
									<div class="portlet-body">
										...
										if($message){ echo '<span class="help-block help-block-success">'.$message.'</span>'; }									?>
											...
											<div class="tab-pane active" id="tab_1_1">
												<form role="form" class="form-horizontal form-bordered" method="post" action="<?php echo base_url('homepage/update_Info') ?>" >
												<div class="col-md-9">
													<h4>Hompage Info: </h4> 
													...
													<div class="form-group">
														...
														<div class="row">
														<div class="col-md-6">
														<input type="text"  readonly class="form-control" name="logo_url" value="<?php if(isset($val->logo_url) && !empty($val->logo_url)){echo $val->logo_url; } ?>"/>
															<a class="btn green btn-outline sbold" data-toggle="modal" href="#draggable"> Add Logo </a>
														</div>
															<input type="hidden" class="form-control" name="id" value="<?php if(isset($val->id) && !empty($val->id)){echo $val->id; } ?>"/>
													...
													<div class="form-group">
														<label class="control-label col-md-3">Review Api Key:</label>
														<div class="col-md-9">
															<input type="text" class="form-control" name="api_key" value="<?php if(isset($val->api_key) && !empty($val->api_key)){echo $val->api_key; } ?>"/>
														</div>	
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Address:</label>
														<div class="col-md-9">
															<input type="text" class="form-control" name="address" value="<?php if(isset($val->address) && !empty($val->address)){echo $val->address; } ?>"/>
														</div>	
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-md-9">
															<input type="text" class="form-control" name="website" value="<?php if(isset($val->website) && !empty($val->website)){echo $val->website; } ?>"/>
														</div>	
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-9">
															<input type="text" class="form-control" name="counter[count1]" 
													...
													<div class="form-group">
														...
														<div class="col-md-9">
															<input type="text" class="form-control" name="counter[count2]" value="<?php if(isset($counter['count2']) && !empty($counter['count2'])){echo $counter['count2'];} ?>"  />
														</div>	
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Counter3:</label>
														<div class="col-md-9">
															<input type="text" class="form-control" name="counter[count3]" value="<?php if(isset($counter['count3']) && !empty($counter['count3'])){echo $counter['count3'];} ?>" />
														</div>	
													</div>
													<div class="form-group">
														<label class="control-label col-md-3">Counter4:</label>
														<div class="col-md-9">
															<input type="text" class="form-control" name="counter[count4]" value="<?php if(isset($counter['count4']) && !empty($counter['count4'])){echo $counter['count4'];} ?>" />
														</div>	
													</div>
													<hr>
												<div class="form-group">
...
<div class="modal fade draggable-modal ui-draggable in" id="draggable" tabindex="-1" role="basic" aria-hidden="true" style="display: none; padding-right: 17px;">
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="clearfix margin-top-10">
							...
							<span class='red'> Image size not bigger then 2 MB and dimensions(300px X 60px).</span>
						</div>
					</div>
				</div>
			</div>
...
$('.upload-result').on('click', function (ev) {
	...
	$uploadCrop.croppie('result', {
		...
		size: 'viewport'
			...
			type: "POST",
			data: {"image":resp,'name':name,'id':id},
			success: function (data) {
				console.log(data);
					if( data == "success" ){
						res.html('<div class="alert alert-success"><strong>Success: </strong> Logo successfully uploaded!</div>');
