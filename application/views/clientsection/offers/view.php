		...
		<div class="page-content">
				...
				<div class="portlet-body">
					...
					<div class="col-md-12">
						...
						<div class="col-md-10"><?php echo isset($offer->offer_status) && $offer->offer_status == 1 ? "Active" : "Inactive"; ?></div>
					</div>
					<div class="col-md-12">
					...
					<div class="text-center">
						<a title='Edit Offer' href="<?php echo site_url("clientsection/offer_edit/{$offer->id}"); ?>" class="" ><i class="fa fa-pencil"></i> Edit Offer</a>
					</div>	
