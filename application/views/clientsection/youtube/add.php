		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="form-group">
					...
					<input type="text" required placeholder="eg: Shimla View" name="name" class="form-control" value=""/> 
				</div>
				</div>
				<div class="col-md-12">
				...
				<div class="form-group">
					...
					<input type="url" required placeholder="eg: https://www.youtube.com/watch?v=YE7VzlLtp-4" name="youtube_vid_link" class="form-control" value=""/> 
				</div>
				</div>
			</div>
