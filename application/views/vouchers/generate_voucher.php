<div class="page-container itinerary-view">
	<div class="page-content-wrapper">
		...
		<?php }else{ ?>
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-users"></i><strong>VOUCHER NUMBER: </strong><?php echo $voucher->voucher_id; ?></div>
					<a class="btn btn-success pull-right" href="<?php echo site_url("vouchers"); ?>" title="Back">Back</a>
				</div>
			</div>
				<?php 		
				...
				<div class="row2">
						...
						<table class="table table-bordered ">
							<tbody>
								...
								<tr>
									...
									<td><?php echo isset($hotels[0]->total_rooms) ? $hotels[0]->total_rooms : "";  ?></td>
									<td><?php echo $itinerary[0]->t_start_date . " - " . $itinerary[0]->t_end_date; ?></td>
								</tr>
								<tr>
									<td>Duration</td>
								...
								<tr>
									...
									<td><?php echo !empty( $itinerary[0]->cab_category ) ? get_car_name( $itinerary[0]->cab_category ) : "--"; ?></td>
									<td></td>
								</tr>
							</tbody>
						</table>
					...
					<!--HOTELS DETAILS-->
					<?php if( $hotels ){ ?>
						<div class="well well-sm"><h3>Accommodation</h3></div>
						<div class="table-responsive2 printable">
							<table class="table table-bordered">
					...
					<!--VEHICLES DETAILS-->
					<?php if( $cab_booking ){ ?>
						<div class="well well-sm"><h3>Vehicle</h3></div>
						<div class="table-responsive2 printable">
							<table class="table table-bordered">
								<thead class="thead-default">
									<th>Sr.</th>
					...
					<?php if( isset($vtf_booking[0]) ){ ?>
						<div class="well well-sm"><h3>Volvo/Train/Flight Tickets Detail</h3></div>
						<div class="table-responsive2 printable">
							<table class="table table-bordered">
								<thead class="thead-default">
									<th>Sr.</th>
					...
					<hr>
						<div class="form-group col-md-12">
							...
							echo '<div class="text-center"><a title="send voucher to client" href="#" class="btn green uppercase" id="iti_send">Send Voucher</a></div>';
									...
									<div class="modal-body">
										<form id="sentItiForm">
											<div class="form-group">
											  ...
											  <input required type="email" readonly value="<?php echo $customer_email; ?>" class="form-control" id="email" placeholder="Enter customer email" name="customer_email">
											</div>
