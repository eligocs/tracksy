                            ...
                            <form id="form-filter" class="form-horizontal  <?php echo $hideClass; ?>">
                                <div class="actions custom_filter">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                           <label for="">&nbsp;</label>
                                           <select name="filter_box" id="" class="form-control">
                                              ...
                                              <option type="radio" name="filter" value="notwork" id="notwork">Not Process</option>
                                              ...
                                              <option  name="filter" value="8" id="declined">Declined</option>
                                              <option  type="radio" name="filter" value="revised" id="amendment">Amendment</option>
                                           </select>
                                            <!-- <div class="btn-group" data-toggle="buttons">
