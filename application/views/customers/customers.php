            ...
            <div class="custom_card">
               ...
               <div class="row clearfix">
                  ...
                  <div class="col-md-9">
                     ...
                     <a href="<?php echo site_url("customers") . "/?todayStatus={$todAy}&leadStatus=callnotpicked"; ?>" class="btn btn-info pull-right"><i class="fa fa-phone"></i> Today Call Not Picked</a>
                     <a href="<?php echo site_url("customers") . "/?todayStatus={$todAy}&leadStatus=callpicked"; ?>" class="btn btn-success pull-right"><i class="fa fa-phone"></i> Today Call Picked</a>
                     <a href="<?php echo site_url("customers") . "/?todayStatus={$todAy}"; ?>" class="btn btn-info pull-right"><i class="fa fa-users"></i> Today's Lead</a>
                  </div>
               </div>
