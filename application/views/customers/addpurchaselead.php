	...
	<div class="page-content-wrapper">
		...
		?>
			<div class="portlet box blue">
			   ...
			   <form id="lead_form" action="<?php echo base_url(); ?>purchaseleads/saveleads" method="post" onsubmit="return checkBeforeSubmit()" >
			   <input type="hidden" name="inp[temp_key]" value="<?php echo getTokenKey(15); ?>">
				
				<div class="col-md-4">
				<div class="form-group">
					<label class="control-label">Customer Name*</label>
					<input required type="text" placeholder="eg. Mr. Rajesh Thakur" name="c_name" class="form-control textfield" value=""/> 
				</div>
				</div>
				...
				<div class="form-group">
					...
					<input required type="email" placeholder="Email" name="c_email" class="form-control" value=""/> 
				</div>
				</div>
				...
				<div class="form-group">
					...
					<input required type="number" placeholder="Customer Phone Number" name="c_number" class="form-control numberfield" value=""/> 
				</div>
				</div>
				...
				<div class="margiv-top-10">
					<button type="submit" class="btn green uppercase add_Customer">Add Lead</button>
				</div>
				</div>
					<div class="clearfix"></div>
			</form>
