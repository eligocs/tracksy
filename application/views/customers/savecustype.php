	...
	<div class="page-content-wrapper">
		...
		<?php isset( $customer_type[0]->id ) && $customer_type[0]->id < 3 ? redirect("customers/customer_type") : ""; ?>
			...
			<div class="portlet-title">
					...
					<a class="btn btn-success" href="<?php echo site_url("customers/customer_type"); ?>" title="Back">Back</a>
				</div>
			</div>
			<div class="portlet-body">
				<form role="form" id="addCat" method="post" action="<?php echo site_url("customers/updatecustomertype/" ); ?>">
					<div class="form-group col-md-4">
						<label class="control-label">Customer Type*</label>
						<input type="text" name="customer_type" placeholder="Customer Type. eg: Travel Partner" class="form-control" value="<?php echo isset( $customer_type[0]->name ) ? $customer_type[0]->name : set_value('customer_type'); ?>" />
					</div>
					<hr>
					<div class="clearfix margiv-top-10">
						<input type="hidden" name="id" value="<?php echo isset( $customer_type[0]->id ) ? $customer_type[0]->id : set_value('id'); ?>">
