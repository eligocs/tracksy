...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Testimonials | Track Itinerary Pvt. Lmt.</title>
      <!-- Bootstrap -->
   ...
   <body class="rating-testimonial">
      <div class="content_area">
         <div class="logo">
            <div class="container ">
               <div class="col-md-4 ">
                  <img src="<?php echo base_url();?>site/images/trackv2-logo.png" class="Track Itinerary Software">
               </div>
               <div class=" col-md-8">
                  <ul class="list-inline">
                     <li class="list-inline-item"><a class="fa fa-google" href="https://plus.google.com/u/0/5465413165"><span>Google</span></a></li>
                     <li class="list-inline-item"><a class="fa fa-facebook" href="https://www.facebook.com/trackitinerary"><span>Facebook</span></a></li>
                     ...
                     <div id="tes_id_<?php echo $testimonial->id ?>" class="review_destination_testimonial">
                        ...
                        <div class="col-xs-9">
                           <div class="row review-text">
                              <div class="clearfix">
                                 <p class="pull-left testimonial-title-client"><a href="#" class=""><?php echo $testimonial->package_name; ?></a></p>
      ...
      <div class="bg-blue">
         <div class="container">
            <div class="row">
               <div class="row iata">
                  <div class="col-md-4 iatacol ">
                     <div class="grabber fff ptb">
                        <h5 class="wa text-capitalize">Approved by</h5>
                        <div>
                           <img src="<?php echo site_url('/');?>site/assets/images/approve.png" alt="Approve" class="img-responsive">
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4 iatacol">
                  ...
                  <div class="col-md-4 iatacol">
                     <div class="grabber grabberwa fff ptb">
                        ...
                        <div class="mitem">
                           <img src="<?php echo site_url('/');?>site/assets/images/payment-type.png" alt="Payment Modes" class="img-responsive">
                        </div>
                     </div>
                  </div>
               </div>
