	...
	<div class="page-content-wrapper">
		...
		?>		<style>		.dis_block{display: block;}		.hide_div{display: none;}		</style>
			...
			<div class="portlet-body">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<select name="account_type" class="form-control account_type" required="required">
								...
								<option <?php echo isset( $account_listing[0]->account_type ) && $account_listing[0]->account_type == "bank" ? "selected" : ""; ?> value="bank">Bank</option>
								<option <?php echo isset( $account_listing[0]->account_type ) && $account_listing[0]->account_type == "cash" ? "selected" : ""; ?> value="cash">Cash</option>
							</select>
						</div>
					</div>					
					...
					<?php if(isset( $account_listing[0]->id ) ) {
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="checkbox" name="acc_status" <?php echo $check_status; ?> class="form-control">
							</div>
						</div>
					<?php } ?>
				...
				<div class="clearfix"></div>				<hr>
				<div class="margiv-top-10">					<input type="hidden" name="id" value="<?php echo isset( $account_listing[0]->id ) ? $account_listing[0]->id : ""; ?>">
					<button type="submit" class="btn green uppercase add_Bank">Add Account</button>
				</div>				<div class="clearfix"></div>				<div id="res"></div>
			</form>
			</div><!-- portlet body -->
			</div> <!-- portlet -->
