            ...
            <form method="post" action="">
                    ...
                    <table class='table margin-top-20'>
                        <tbody>
                            <tr>
                                ...
                                <td class="border_top_zero"><input id="ORDER_ID" tabindex="1" class='form-control'
                                        maxlength="20" size="20" name="ORDER_ID" autocomplete="off"
                                        value="<?php echo $ORDER_ID ?>">
                                </td>
                                <td class="border_top_zero"><input value="Status Query" class='btn btn-success'
                                        type="submit" onclick=""></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body">
                        <table class='table table_payments_status table-striped' style="border: 1px solid nopadding"
                            border="0">
                            <tbody>
                                <?php
