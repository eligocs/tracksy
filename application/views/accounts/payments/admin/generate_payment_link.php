		...
		?>		<style>		.dis_block{display: block;}
		   ...
		   <div class="portlet box blue">
			<div class="portlet-title">
				...
				<a class="btn btn-success" href="<?php echo site_url("accounts/all_online_transactions");?>" title="Back">Back</a>
			</div>
			</div>
			<?php 
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" placeholder="Customer Name" name="customer_name" class="form-control" value="<?php echo $customer_name; ?>" required="required"/> 
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="email" placeholder="Customer Email" name="customer_email" class="form-control" value="<?php echo $customer_email; ?>" required="required"/> 
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" placeholder="Customer Contact"  name="customer_contact" class="form-control" value="<?php echo $customer_contact; ?>" required="required"/> 
						</div>
					</div>
					...
					<div class="clearfix"></div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" disabled placeholder="Total Package cost" name="total_package_cost" class="form-control" value="<?php echo isset( $payment_link[0]->iti_id ) ? iti_final_cost($payment_link[0]->iti_id) : "" ?>" required="required"/> 
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="number" id='amount' placeholder="Enter Amount" name="amount" min="10" class="form-control" value="<?php echo isset($payment_link[0]->trans_amount) ? $payment_link[0]->trans_amount : 0;?>" required="required"/> 
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" id='expire_date' placeholder="Enter Link Expire Date" autocomplete="off" name="link_expire_date" class="form-control" value="<?php echo isset($payment_link[0]->link_expire_date) ? $payment_link[0]->link_expire_date : "";?>" required="required"/> 
							</div>
						</div>
