			...
			<div class="portlet-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered">
						...
						<div id="res"></div>
						<?php 
						/*if( isset($get_all_transactions) && !empty( $get_all_transactions ) ){
							$i = 1;
							foreach( $get_all_transactions as $transaction ) {
								...
								<tr data-id={$transaction->id}>
									...
									<td>
										<a href=" . site_url("accounts/view_pay/{$transaction->id}") . " class='btn btn-success' target='_blank' title='View Payement' ><i class='fa fa-eye'></i>
										</a>
									</td>
								</tr>";
								$i++; 
							...
							echo "<tr>";
							for( $colspan = 1 ; $colspan <= 10; $colspan++ ){
