		...
		<div class="page-content">
			...
			<div class="portlet-body">
				...
				<div class="form-group">
					...
					<input  id="PaSS" type="password" placeholder="Enter your password" name="password" class="form-control" value="" /> 
				</div>
				</div>
				<div class="col-md-4">
				<div class="form-group">
					<label class="control-label">Confirm Password*</label>
					<input  type="password" placeholder="Confirm password" name="c_password" class="form-control" value="" /> 
				</div>
				</div>
				...
				<div class="form-group">
					...
					<input  type="text" placeholder="Mobile" name="website" class="form-control" value="http://trackitinerary.org/"/> 
				</div>
				</div>
