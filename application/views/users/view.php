		 ...
		 <div class="second_custom_card">
			...
			<div class="portlet-body">
				...
				<table class="table table-condensed table-hover table-striped">
					...
					<tr>
						<td width="20%">
							<div class="col-mdd-2 form_vl border_right_none"><strong>Office Timing: </strong></div>
						</td>
						<td>
				...
				<tr>
				<td width="20%"><div class="col-mdd-2 form_vl border_right_none"><strong>Mobile Number For Login:</strong></div></td>	
				<td><div class="col-mdd-10 form_vr"><strong><?php echo $agent->mobile_otp; ?></strong></div></td>
				</tr>
				<tr>
				<td width="20%"><div class="col-mdd-2 form_vl border_right_none"><strong>Gender:</strong></div></td>	
				...
				<?php } ?>
				<tr>
				<td width="20%"><div class="col-mdd-2 form_vl border_right_none"><strong>User Role:</strong></div></td>	
				<td><div class="col-mdd-10 form_vr green"><strong><?php echo $agent_type; ?></strong></div></td>
				</tr>
				<tr>
				<td width="20%"><div class="col-mdd-2 form_vl border_right_none"><strong>Added By:</strong></div></td>	
				<td><div class="col-mdd-10 form_vr"><?php echo get_user_name($agent->added_by); ?></div></td>
				</tr>
				<tr>
				<td width="20%"><div class="col-mdd-2 form_vl border_right_none"><strong>User Status:</strong></div></td>	
				<td><div class="col-mdd-10 form_vr"><?php echo $agent->user_status; ?></div></td>
				</tr>
				<tr>
				<td width="20%"><div class="col-mdd-2 form_vl border_right_none"><strong>Website:</strong></div></td>	
