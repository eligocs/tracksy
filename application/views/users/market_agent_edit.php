	...
	<div class="page-content-wrapper">
		...
		<?php if($agent){ 	$agent = $agent[0];		?>
			...
			<div class="form-group">
				...
				<input required type="text" name="firstname" placeholder="First Name" class="form-control" value="<?php echo $agent->first_name;?>" /> </div></div>
				<div class="col-md-4">
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input required type="text" placeholder="Mobile" name="mobile" class="form-control" value="<?php echo $agent->mobile;?>"/> </div>
			</div>
			<div class="clearfix"></div>
			...
			<div class="form-group">
			   ...
			   <input required name="gender" value="male" <?php if($agent->gender=='male'){ echo "checked=checked";}  ?> id="lmale" type="radio"> <label for="lmale">Male</label>
			   <input required name="gender" <?php if($agent->gender=='female'){ echo "checked=checked";}  ?> id="female" value="female" type="radio"> <label for="female">Female</label>
			</div>
			</div>
...
jQuery(document).ready(function($){
	...
	form.validate({
		...
		submitHandler: function(form) {
			...
			ajaxReq = jQuery.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>" + "Agents/ajax_edit_market_agent",
				dataType: 'json',
				data: formData,
				beforeSend: function(){
