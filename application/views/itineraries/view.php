	...
	<div class="page-content-wrapper">
		...
		?>
			<?php if( !empty($itinerary[0] ) ){ 			
						...
						if( ($user_role == 99 || $user_role == 98 || $user_role == 96 ) && $iti->iti_status == 9 && isset( $paymentDetails[0] ) ){
							...
							if( !empty($tend_d) && $tend_d <= $td ){
								...
								if( $check_if_request_sent ){
									$rev_btn = "<strong clas='btn btn-success'><i class='fa fa-check-circle-o'></i> Review Link Sent</strong>";
								}else{
									$rev_btn = "<a title='Send review link to customer' target='_blank' href='javascript: void(0)' class='btn btn-success sendReview_req' data-cusid = '{$iti->customer_id}' >Send review link</a>";
								}
								echo "<div class='pull-right' style='margin: 5px;'>{$rev_btn}</div>";
								echo '<div class = "spinner_load"  style = "display: none;">
				...
				<?php 
				 /*if( get_iti_booking_status( $iti->iti_id ) == 3 && $iti->iti_status != 9 ){ 
				...
				<?php if( isset( $paymentDetails[0] ) && !empty( $paymentDetails[0] ) && $iti->iti_status == 9 ){ 
						...
						<!--show payment screenshot details-->
							...
							<div id="update_iti_hold_status">
								...
								<?php 
								if( is_admin_or_manager() && $pay_detail->iti_booking_status == 1 ){
				...
				<?php
					//$string = "Ø";
					//$t = htmlentities($string, ENT_COMPAT, 'UTF-8');
					//$this->global_model->update_data( "itinerary" , array("iti_id" => $iti->iti_id) , array("iti_reject_comment" => $t) );
				?>
				...
				************************/
				...
				if( ( (empty($get_rate_meta) || get_iti_booking_status($iti->iti_id)  == 3) || $iti->pending_price == 1 ) && ( ( ( ( is_manager() && !is_leads_manager() ) || is_admin() ) && ( $iti->pending_price == 1 || $iti->pending_price == 5 ) ) || ( is_teamleader() && $iti->pending_price == 5 ) ) ){ ?>
					...
					<div class="row" id="update_rates_section">
						<form id="submitRates">
							...
							<div class="clearfix"></div>
							<!--perperson rate meta -->
							<div class="col-md-10 perperson_section" style="display: none;">
								<div class='standard  form-group col-md-3' >
									<label><strong>Deluxe (Per/Person):</strong></label>
									<input name="per_person_ratemeta[standard_rates]" type="number" class='form-control' placeholder="Deluxe Per/Person Cost"></input>
								</div>
								
								<div class='deluxe form-group col-md-3' >
									<label><strong>Super Deluxe (Per/Person):</strong></label>
									<input name="per_person_ratemeta[deluxe_rates]" type="number" class='form-control' placeholder="Super Deluxe Per/Person Cost"></input>
								</div>
								<div class='super_deluxe form-group col-md-3' >
									<label><strong>Luxury (Per/Person):</strong></label>
									<input name="per_person_ratemeta[super_deluxe_rates]" type="number" class='form-control' placeholder="Luxury Per/Person Cost"></input>
								</div>
								<div class='luxury form-group col-md-3' >
									<label><strong>Super Luxury (Per/Person):</strong></label>
									<input name="per_person_ratemeta[luxury_rates]" type="number" class='form-control' placeholder="Super Deluxe Per/Person Cost"></input>
								</div>
								<div class="clearfix"></div>
								<!--child rate-->
								<div class='standard  form-group col-md-3' >
									<label><strong  class="red">Deluxe (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
									<input name="per_person_ratemeta[child_standard_rates]" type="number" class='form-control' placeholder="Deluxe Per/child Cost"></input>
								</div>
								...
								<div class='deluxe form-group col-md-3' >
									...
									<input name="per_person_ratemeta[child_deluxe_rates]" type="number" class='form-control' placeholder="Super Deluxe Per/child Cost"></input>
								</div>
								<div class='super_deluxe form-group col-md-3' >
									<label><strong  class="red">Luxury (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
									<input name="per_person_ratemeta[child_super_deluxe_rates]" type="number" class='form-control' placeholder="Luxury Per/child Cost"></input>
								</div>
								<div class='luxury form-group col-md-3' >
									...
									<input name="per_person_ratemeta[child_luxury_rates]" type="number" class='form-control' placeholder="Super Deluxe Per/child Cost"></input>
								</div>
							</div>
						  ...
						  <div class="modal-content">
							...
							<div class="modal-body">
								<form id="frm_rejectItinerary">
									...
									<button type="submit" id="reqDis_btn" class="btn btn-success">Submit To Reject</button>
									<div id="rej_res"></div>
								</form>
					...
					</div><!--END Reject Itinerary Modal -->
				<?php }else if( is_teamleader() &&  $iti->pending_price == 5 ){
				...
				<?php if( !empty($get_rate_meta) && ( is_admin() || is_super_manager() ) && $iti->pending_price == 4 ){ ?>
					<div class="row" id="update_rates_section">
						...
						<?php 
							...
							<div class='standard  form-group col-md-2' >
								<label><strong>Deluxe:</strong></label>
								<input required name="rate_meta[standard_rates]" type="number" class='form-control' value="<?php echo isset($get_rate_meta["standard_rates"]) ? $get_rate_meta["standard_rates"] : 0; ?>"></input>
							</div>
							<div class='deluxe form-group col-md-2' >
								<label><strong>Super Deluxe:</strong></label>
								<input required name="rate_meta[deluxe_rates]" type="number" class='form-control' value="<?php echo isset($get_rate_meta["deluxe_rates"]) ? $get_rate_meta["deluxe_rates"] : 0; ?>" ></input>
							</div>
							<div class='super_deluxe form-group col-md-2' >
								<label><strong>Luxury:</strong></label>
								<input required name="rate_meta[super_deluxe_rates]" type="number" class='form-control' value="<?php echo isset($get_rate_meta["super_deluxe_rates"]) ? $get_rate_meta["super_deluxe_rates"] : 0; ?>" ></input>
							</div>
							<div class='luxury form-group col-md-2' >
								<label><strong>Super Luxury:</strong></label>
								<input required name="rate_meta[luxury_rates]" type="number" class='form-control' value="<?php echo isset($get_rate_meta["luxury_rates"]) ? $get_rate_meta["luxury_rates"] : 0; ?>" ></input>
							</div>
							...
							<div class="col-md-12 perperson_section" style="display: <?php echo !empty( $check_perperson ) ? "block" : "none"; ?>">
								...
								<div class='standard  form-group col-md-3' >
									<label><strong  class="red">Deluxe (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
									<input name="per_person_ratemeta[child_standard_rates]" type="number" value="<?php echo $child_s_pp; ?>"  class='form-control' placeholder="Deluxe Per/child Cost"></input>
								</div>
								
								<div class='deluxe form-group col-md-3' >
									<label><strong class="red">Super Deluxe (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
									<input name="per_person_ratemeta[child_deluxe_rates]" type="number" value="<?php echo $child_d_pp; ?>"  class='form-control' placeholder="Super Deluxe Per/child Cost"></input>
								</div>
								<div class='super_deluxe form-group col-md-3' >
									<label><strong  class="red">Luxury (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
									<input name="per_person_ratemeta[child_super_deluxe_rates]" type="number" value="<?php echo $child_sd_pp; ?>"  class='form-control' placeholder="Luxury Per/child Cost"></input>
								</div>
								<div class='luxury form-group col-md-3' >
									<label><strong  class="red">Super Luxury (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
									<input name="per_person_ratemeta[child_luxury_rates]" type="number" value="<?php echo $child_l_pp; ?>"  class='form-control' placeholder="Super Deluxe Per/child Cost"></input>
								</div>
							</div>
							<!--end perperson rate meta -->
				...
				$dis_hotel_cat	 = $iti->dis_hotel_cat;
					...
					<div class="row" id="update_rates_section">
						...
						<div class="table-responsive">
							<table class="table table-striped table-hover">
								...
								<tbody>
									<tr>
										<td><?php echo isset($get_rate_meta["standard_rates"]) && !empty($get_rate_meta["standard_rates"]) ? number_format($get_rate_meta["standard_rates"]) . "/- {$inc_gst} <br> {$s_pp}<br> {$child_s_pp}" : ''; ?></td>
										<td><?php echo isset($get_rate_meta["deluxe_rates"]) && !empty($get_rate_meta["deluxe_rates"]) ? number_format($get_rate_meta["deluxe_rates"]). "/- {$inc_gst}<br> {$d_pp}<br> {$child_d_pp}" : ''; ?></td>
										<td><?php echo isset($get_rate_meta["super_deluxe_rates"]) && !empty($get_rate_meta["super_deluxe_rates"]) ? number_format($get_rate_meta["super_deluxe_rates"]). "/- {$inc_gst}<br> {$sd_pp}<br> {$child_sd_pp}" : ''; ?></td>
										<td><?php echo isset($get_rate_meta["luxury_rates"]) && !empty($get_rate_meta["luxury_rates"]) ?  number_format($get_rate_meta["luxury_rates"]). "/- {$inc_gst} <br> {$l_pp}<br> {$child_l_pp}" : ''; ?></td>
									...
									<?php if( !empty( $discountPriceData ) ){
										foreach( $discountPriceData as $price ){
											...
											echo "<td><strong>" . $l_price . "</strong> {$inc_gst} <br> {$l_pp}<br>{$child_l_pp}</td>";
						...
						<?php if( !empty( $dis_hotel_category_a ) && $iti->iti_status == 0 ){ ?>
							<form id="frmDiscountRates">
								...
								<div class='update_price_customprice' style="display: none;">
									<div class='standard  form-group col-md-2' >
										<label><strong>Deluxe:</strong></label>
										<input name="standard_rates" type="number" <?php if( !in_array("Standard", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control'></input>
									</div>
									<div class='deluxe form-group col-md-2' >
										<label><strong>Super Deluxe:</strong></label>
										<input <?php if( !in_array("Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> name="deluxe_rates" type="number" class='form-control'></input>
									</div>
									<div class='super_deluxe form-group col-md-2' >
										<label><strong>Luxury:</strong></label>
										<input <?php if( !in_array("Super Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?>  name="super_deluxe_rates" type="number" class='form-control'></input>
									</div>
									<div class='luxury form-group col-md-2' >
										<label><strong>Super Luxury:</strong></label>
										<input <?php if( !in_array("Luxury", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> name="luxury_rates" type="number" class='form-control'></input>
									</div>
									...
									<div class="col-md-12 perperson_section" style="display: none;">
										<div class='standard  form-group col-md-3' >
											<label><strong>Deluxe (Per/Person):</strong></label>
											<input name="per_person_ratemeta[standard_rates]" type="number" <?php if( !in_array("Standard", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control' placeholder="Deluxe Per/Person Cost"></input>
										</div>
										
										<div class='deluxe form-group col-md-3' >
											<label><strong>Super Deluxe (Per/Person):</strong></label>
											<input name="per_person_ratemeta[deluxe_rates]" type="number" <?php if( !in_array("Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control' placeholder="Super Deluxe Per/Person Cost"></input>
										</div>
										<div class='super_deluxe form-group col-md-3' >
											<label><strong>Luxury (Per/Person):</strong></label>
											<input name="per_person_ratemeta[super_deluxe_rates]" type="number" <?php if( !in_array("Super Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control' placeholder="Luxury Per/Person Cost"></input>
										</div>
										<div class='luxury form-group col-md-3' >
											<label><strong>Super Luxury (Per/Person):</strong></label>
											<input name="per_person_ratemeta[luxury_rates]" type="number" <?php if( !in_array("Luxury", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control' placeholder="Super Deluxe Per/Person Cost"></input>
										</div>
										<div class="clearfix"></div>
										<!--child rate-->
										<div class='standard  form-group col-md-3' >
											<label><strong  class="red">Deluxe (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
											<input <?php if( !in_array("Standard", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> name="per_person_ratemeta[child_standard_rates]" type="number"  class='form-control' placeholder="Deluxe Per/child Cost"></input>
										</div>
										
										<div class='deluxe form-group col-md-3' >
											<label><strong class="red">Super Deluxe (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
											<input <?php if( !in_array("Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> name="per_person_ratemeta[child_deluxe_rates]" type="number"  class='form-control' placeholder="Super Deluxe Per/child Cost"></input>
										</div>
										<div class='super_deluxe form-group col-md-3' >
											<label><strong  class="red">Luxury (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
											<input <?php if( !in_array("Super Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> name="per_person_ratemeta[child_super_deluxe_rates]" type="number" class='form-control' placeholder="Luxury Per/child Cost"></input>
										</div>
										<div class='luxury form-group col-md-3' >
											<label><strong  class="red">Super Luxury (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
											<input  <?php if( !in_array("Luxury", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> name="per_person_ratemeta[child_luxury_rates]" type="number" class='form-control' placeholder="Super Deluxe Per/child Cost"></input>
										</div>
									</div>
									<!--end perperson rate meta -->
								</div><!--CUSTOM DISCOUNT PRICE-->
				...
				<?php if( !empty( $discount_pending_rates ) && ( is_admin() || is_super_manager() ) && $iti->discount_rate_request == 2 ){ ?>
					...
					<form id="frmDiscountSupermanager">
						...
						<div class="col-md-12 perperson_section" style="display: <?php echo !empty($check_perperson) ? "block" : "none"; ?>;">
							<div class='standard  form-group col-md-3' >
								<label><strong>Deluxe (Per/Person):</strong></label>
								<input name="per_person_ratemeta[standard_rates]"  value="<?php echo $s_pp; ?>"  type="number" <?php if( !in_array("Standard", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control' placeholder="Deluxe Per/Person Cost"></input>
							</div>
							
							<div class='deluxe form-group col-md-3' >
								<label><strong>Super Deluxe (Per/Person):</strong></label>
								<input name="per_person_ratemeta[deluxe_rates]"  value="<?php echo $d_pp; ?>" type="number" <?php if( !in_array("Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control' placeholder="Super Deluxe Per/Person Cost"></input>
							</div>
							<div class='super_deluxe form-group col-md-3' >
								<label><strong>Luxury (Per/Person):</strong></label>
								<input name="per_person_ratemeta[super_deluxe_rates]"  value="<?php echo $sd_pp; ?>" type="number" <?php if( !in_array("Super Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control' placeholder="Luxury Per/Person Cost"></input>
							</div>
							<div class='luxury form-group col-md-3' >
								<label><strong>Super Luxury (Per/Person):</strong></label>
								<input name="per_person_ratemeta[luxury_rates]" type="number" <?php if( !in_array("Luxury", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> class='form-control' value="<?php echo $l_pp; ?>" placeholder="Super Deluxe Per/Person Cost"></input>
							</div>
							...
							<div class='standard  form-group col-md-3' >
								<label><strong  class="red">Deluxe (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
								<input name="per_person_ratemeta[child_standard_rates]" <?php if( !in_array("Standard", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?>  type="number" value="<?php echo $child_s_pp; ?>"  class='form-control' placeholder="Deluxe Per/child Cost"></input>
							</div>
							
							<div class='deluxe form-group col-md-3' >
								<label><strong class="red">Super Deluxe (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
								<input name="per_person_ratemeta[child_deluxe_rates]" type="number"  <?php if( !in_array("Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> value="<?php echo $child_d_pp; ?>"  class='form-control' placeholder="Super Deluxe Per/child Cost"></input>
							</div>
							<div class='super_deluxe form-group col-md-3' >
								<label><strong  class="red">Luxury (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
								<input name="per_person_ratemeta[child_super_deluxe_rates]" type="number" <?php if( !in_array("Super Deluxe", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> value="<?php echo $child_sd_pp; ?>"  class='form-control' placeholder="Luxury Per/child Cost"></input>
							</div>
							<div class='luxury form-group col-md-3' >
								<label><strong  class="red">Super Luxury (Per/child):</strong><span style="font-size:10px; color: red;"> ( Leave empty if not exists)</span></label>
								<input <?php if( !in_array("Luxury", $dis_hotel_category_a ) ){ echo "readonly"; }else{ echo "required"; } ?> name="per_person_ratemeta[child_luxury_rates]" type="number" value="<?php echo $child_l_pp; ?>"  class='form-control' placeholder="Super Deluxe Per/child Cost"></input>
							</div>
				...
				<div class="portlet box blue">
					...
					<?php if( ( $iti->iti_status == 0 || $iti->iti_status == 6 ) && is_admin_or_manager_or_sales() ){ ?>
						<a title='Edit Itinerary' href=" <?php echo site_url("itineraries/edit/{$iti->iti_id}/{$iti->temp_key}") ; ?> " class='btn btn-success pull-right'><i class='fa fa-pencil' aria-hidden='true'></i></a>
					<?php } ?>
												...
												<form id="reqPriceForm">
													<div class="form-group">
														<div class="checkbox">
															...
															<label><input name="hotel_cat_dis[]" required type="checkbox" value="Standard"> <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span><strong>Deluxe</strong></label><br>
															<label><input name="hotel_cat_dis[]" required type="checkbox" value="Deluxe"> <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span><strong>Super Deluxe</strong></label><br>
															<label><input name="hotel_cat_dis[]" required type="checkbox" value="Super Deluxe"> <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span><strong>Luxury</strong></label><br>
															<label><input type="checkbox" required name="hotel_cat_dis[]" value="Luxury"> <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span><strong>Super Luxury</strong></label>
														</div>
													</div>
														...
														<div class="frm_section">
															...
															?>
																	<div class="col-md-6">
																		...
																		<select id="inp_inc_price" class="form-control" data-old_percentage="<?php echo !empty($old_per) ? $old_per : 0; ?>" name="agnem" required >
			...
			$.ajax({
				...
				success: function(res) {
					...
					if( res.status == true ){
						...
						resp.html('<div class="alert alert-danger"><i class="fa fa-spinner fa-spin"></i> '+res.msg+'</div>');
					}
				},
				error: function(e){
					$(".spinner_load").hide();
...
<script type="text/javascript">
	...
	$(document).on("click", '.sendReview_req', function(e) {
		...
		if( confirm( "Are you sure to send review request to customer ?" ) ){
			$(".spinner_load").show();
			$.ajax({
				url: "<?php echo base_url(); ?>" + "customers/update_review_status?customer_id=" + cus_id,
				type:"GET",
				data:cus_id,
				dataType: 'json',
				cache: false,
				success: function(r){
					...
					if(r.status = true){
						...
						//_this.removeClass("sendReview_req").html("<i class='fa fa-check-circle-o'></i> Sent");
						location.reload();
					}else{
