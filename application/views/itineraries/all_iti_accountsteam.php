		...
		<div class="portlet box blue" style="margin-bottom:0;">
			...
			<div class="row3 marginBottom clearfix">
				...
				<!--start filter section-->
					<form id="form-filter" class="flex1 form-horizontal marginRight<?php echo $hideClass; ?>">
						...
						<div class="col-md-6"><strong>&nbsp; </strong><br>
							<div class="btn-group" data-toggle="buttons">
								...
								<!--label title="Open Itineraris" class="btn btn-default btn-success custom_active"><input type="radio" name="filter" value="pm_oi" id="pm_oi" />Open</label-->
								
								<label title="Pending Bank Receipt" class="btn btn-default btn-success custom_active"><input type="radio" name="filter" value="pending_invoice" id="pending_invoice" />Pending Bank Rec.</label>
							</div>	
