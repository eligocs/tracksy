                ...
                <form id="itiForm_Frm">
                    <div class="form-horizontal over" id="itiForm_form">
                        ...
                        <section class="well bg_white overflow_visible section_customer_details">
                            ...
                            <div class="col-md-2">
                                <strong><?php if(isset($cust->customer_email)){ echo $cust->customer_email; }?>
                                </strong>
                            </div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" required class="form-control" name="adults"
                                                ...
                                                <div class="col-md-8">
                                                    <select required name="cab_category" class="form-control">
                                                        ...
                                                        <option <?php if ( $iti->cab_category == $car->id ) { ?>
                                                            ...
                                                            value="<?php echo $car->id ?>"><?php echo $car->car_name; ?>
                                                        </option>;
                                                        <?php }
														}
													?>
									...
									?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <select title="Select Total Rooms" required
                                                        ...
                                                        <option value="00"
                                                            <?php if( $total_rooms == "00" ){ echo "selected='selected'"; } ?>>
                                                            0</option>
                                                        <?php 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-4">Extra bed/Without extra
                                                    bed</label>
                                                <div class="col-md-4">
                                                    <select title="Select with extra bed"
                                                        name="rooms_meta[with_extra_bed]" class="form-control">
                                                        <option value="">Select Extra Bed</option>
                                                        <option value="00"
                                                            <?php if( $with_extra_bed == "00" ){ echo "selected='selected'"; } ?>>
                                                            0</option>
                                                        <?php 
														for( $eb = 1 ; $eb <= 60 ; $eb ++  ){
                                                ...
                                                <div class="col-md-4">
                                                    <select title="Select without extra bed"
                                                        name="rooms_meta[without_extra_bed]" class="form-control">
                                                        <option value="">Select Without Extra Bed</option>
                                                        <option value="00"
                                                            <?php if( $without_extra_bed == "00" ){ echo "selected='selected'"; } ?>>
                                                            0</option>
                                                        <?php 
													for( $wm = 1 ; $wm <= 60 ; $wm ++  ){
                                                ...
                                                <div class="col-md-8">
                                                    <label class='mt-checkbox'>
                                                        <input type='checkbox'
                                                            ...
                                                            name="is_flight" id='flight_ck'
                                                            class='input-group form-control' value="1"><span></span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <section
                                            ...
                                            <div class="text-center form_ft_btns  margin_top_n40">
                                                <div class="btn-group flight_train_btns margin-bottom-40"
                                                    data-toggle="buttons">
                                                    <label
                                                        class="btn btn-default  custom_active <?php if( isset($flight->trip_type) && $flight->trip_type  == "oneway" || empty($flight) ){ echo "active"; }?> ">
                                                        <input
                                                    ...
                                                    <label
                                                        class="btn btn-default  custom_active <?php if( isset($flight->trip_type) && $flight->trip_type  == "round" ){ echo "active"; } ?>"><input
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input required class="input-group form-control" size="16"
                                                            type="text"
                                                            value="<?php if(isset($flight->flight_name)){ echo $flight->flight_name; } ?>"
                                                            name="flight_name" placeholder="Jet Airways,SpiceJet etc" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input required class="input-group form-control"
                                                            placeholder="Mumbai,Shimla etc" size="16" type="text"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input required readonly
                                                            class="input-group form-control flight_dateTime" size="16"
                                                            type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input readonly
                                                            <?php if(isset($flight->return_date) && empty($flight->return_date) ){ echo "disabled"; } ?>
                                                            class="input-group form-control <?php if(isset($flight->return_arr_date) && !empty($flight->return_arr_date) ){ echo "flight_dateTime"; } ?>"
                                                            size="16" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input readonly
                                                            <?php if(isset($flight->return_arr_date) && empty($flight->return_arr_date) ){ echo "disabled"; } ?>
                                                            class="input-group form-control <?php if(isset($flight->return_arr_date) && !empty($flight->return_arr_date) ){ echo "flight_dateTime"; } ?>"
                                                            size="16" type="text"
                                                            value="<?php if(isset($flight->return_arr_date)){ echo $flight->return_arr_date; } ?>"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input required class="input-group form-control" size="16"
                                                            placeholder="10000 etc." type="number"
                                        ...
                                        <section
                                            ...
                                            <div class="text-center form_ft_btns margin_top_n40">
                                                <div class="btn-group flight_train_btns margin-bottom-40"
                                                    data-toggle="buttons">
                                                    <label
                                                        class="btn btn-default custom_active <?php if( isset($train->t_trip_type) && $train->t_trip_type  == "oneway" || empty($train) ){ echo "active"; }?> ">
                                                        <input
                                                            ...
                                                            required />One Way</label>
                                                    <label
                                                        class="btn btn-default  custom_active <?php if( isset($train->t_trip_type) && $train->t_trip_type  == "round" ){ echo "active"; } ?>"><input
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input required class="input-group form-control" size="16"
                                                            ...
                                                            name="train_number" placeholder="11050, 11052 etc" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input required readonly
                                                            class="input-group form-control train_dateTime" size="16"
                                                            type="text"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input readonly
                                                            ...
                                                            class="input-group form-control <?php if(isset($train->t_return_date) && !empty($train->t_return_date) ){ echo "train_dateTime"; } ?>"
                                                            size="16" type="text"
                                                    ...
                                                    <div class="col-md-8">
                                                        <select required name="t_class" class="form-control">
                                                            ...
                                                            <option
                                                                ...
                                                                value="Sleeper class">Sleeper class</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div data-repeater-list="tour_meta" class="day-wise-tour">
                                                    ...
                                                    <div data-repeater-item class="mt-repeater-item daywise_section">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-2">
                                                                        <div class="mt-repeater-input form-group">
                                                                            <label
                                                                                class="control-label">Day</label><span
                                                                                class="required"> * </span>
                                                                            <br />
                                                                    ...
                                                                    <div class="mt-repeater-input  t_title">
                                                                        <label class="control-label">Tour
                                                                            Title*</label><span class="required"> *
                                                                        </span>
                                                                        <br />
                                                                ...
                                                                <div class="mt-repeater-input  ">
                                                                    ...
                                                                    <select required name="meal_plan"
                                                                        ...
                                                                        <option
                                                                            ...
                                                                            selected="selected" <?php } ?>
                                                                            value="Breakfast, Lunch & Dinner">Breakfast,
                                                                            Lunch & Dinner</option>
                                                                        <option
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <div
                                                                    class="mt-repeater-input mt-repeater-textarea t_des">
                                                                    <label class="control-label">Tour
                                                ...
                                                <div data-repeater-list="exc_meta">
                                                    ...
                                                    <div data-repeater-item class="mt-repeater-exc-item form-group">
                                                        ...
                                                        <div class="mt-repeater-exc-input col-md-3">
                                                            <a title="delete" href="javascript:;" data-repeater-delete
                                                                class="btn btn-danger mt-repeater-delete">
                                                                <i class="fa fa-close"></i> </a>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane removeMargin" id="tab4">
                                        ...
                                        <div class="mt-repeater-hotel tour_field_repeater">
                                            <div data-repeater-list="hotel_meta">
                                                ...
                                                <div data-repeater-item class="mt-repeater-hotel-item">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            class='mt-repeater-hotel-input standard  form-group col-md-2'>
                                                        ...
                                                        <div class='mt-repeater-hotel-input deluxe form-group col-md-2'>
                                                            ...
                                                            <input type='text' name="hotel_deluxe" class='form-control'
                                                        ...
                                                        <div
                                                            class='mt-repeater-hotel-input super_deluxe form-group col-md-2'>
                                                        ...
                                                        <div class='mt-repeater-hotel-input luxury form-group col-md-2'>
                                                            ...
                                                            <input name="hotel_luxury" type='text' class='form-control'
                                            ...
                                            <a href="javascript:;" data-repeater-create
                                                class="btn btn-success mt-repeater-hotel-add">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class='mt-repeater-hotel-input standard  form-group col-md-3'>
                                                    <label><strong>Deluxe:</strong></label>
                                                    <input required name="rate_meta[standard_rates]" type="number"
                                                        class='form-control'
                                                ...
                                                <div class='mt-repeater-hotel-input deluxe form-group col-md-3'>
                                                    ...
                                                    <input
                                                        ...
                                                        required name="rate_meta[deluxe_rates]" type="number"
                                                ...
                                                <div class='form-group col-md-2'>
                                                    ...
                                                    <input type="checkbox"
                                                        ...
                                                        title="Check if price is below Base Price" class='form-control'
                                                        id="below_bp"></input>
                                                ...
                                                <div class="col-md-12 perperson_section"
                                                    ...
                                                    <div class='standard  form-group col-md-3'>
                                                        <label><strong class="red">Deluxe (Per/child):</strong><span
                                                                style="font-size:10px; color: red;"> ( Leave empty if
                                                    ...
                                                    <div class='deluxe form-group col-md-3'>
                                                        <label><strong class="red">Super Deluxe
                                                                (Per/child):</strong><span
                                                                style="font-size:10px; color: red;"> ( Leave empty if
                                                                not exists)</span></label>
                                                        <input value="<?php echo $child_d_pp; ?>"
                                                            name="per_person_ratemeta[child_deluxe_rates]" type="number"
                                                            class='form-control'
                                                    ...
                                                    <div class='luxury form-group col-md-3'>
                                                        <label><strong class="red">Super Luxury
                                                                (Per/child):</strong><span
                                                                style="font-size:10px; color: red;"> ( Leave empty if
                                                                not exists)</span></label>
                                                        <input value="<?php echo $child_l_pp; ?>"
                                                            name="per_person_ratemeta[child_luxury_rates]" type="number"
                                                            class='form-control'
                                                            placeholder="Super Deluxe Per/child Cost"></input>
                                                    </div>
                                                </div>
...
$(element).closest('.form-group').removeClass('has-success').addClass('has-error'); // set error class to the control
group
},
...
for (var i = 0; i < index; i++) { jQuery(li_list[i]).addClass("done"); } if (current==1) {
    $('#form_wizard_1').find('.button-previous').hide(); } else { $('#form_wizard_1').find('.button-previous').show(); }
    if (current>= total) {
            ...
            jQuery('.mt-repeater').each(function() {
                ...
                $(this).repeater({
                    show: function() {
                        ...
                        var from = $(this).prev(".mt-repeater-item").find(".tour_dt").val()
                            .split("/");
