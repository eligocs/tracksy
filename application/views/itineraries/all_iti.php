      ...
      <div class="page-content">
         ...
         <div class="portlet box blue" style="margin-bottom:0;">
            <div class="portlet-title" >
               ...
               <?php if( $user_role != 97 ){ ?>
               <a class="btn btn-success" href="<?php echo site_url("customers"); ?>" title="add Itineraries">Add Itinerary</a>
               <?php } ?>	
            </div>
         </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-8">
                              ...
                              <div class="btn-group" data-toggle="buttons">
                                 ...
                                 <label class="btn btn-primary custom_active"><input type="radio" name="filter" value="7" id="declined" />Declined</label>
                                 ...
                                 <label title="Travel Date" class="btn btn-primary custom_active"><input type="radio" name="filter" value="travel_date" id="travel_date" />TD</label>
                                 <label title="Temp. Travel Date"  class="btn btn-primary custom_active" style="background-color: gray !important; color: white;" ><input type="radio" name="filter" value="temp_travel_date" id="temp_travel_date" />TTD</label>
                                 <label class="btn btn-primary custom_active"><input type="radio" name="filter" value="revised" id="amendment" />Amendment</label>
                                 <label style="background-color: green !important; color: white;"  title="Agent Margin Greater than 20%" class="btn btn-primary custom_active"><input type="radio" name="filter" value="agent_margen_20" id="agent_margen_20" />AM>=20%</label>
                              </div>
                              <input type="hidden" name="date_from" id="date_from" data-date_from="<?php if( isset( $_GET["leadfrom"] ) ){ echo $_GET["leadfrom"] ; }  else { echo $first_day_this_month; } ?>" value="" >
                              <input type="hidden" name="date_to" id="date_to" data-date_to="<?php if( isset( $_GET["leadto"] ) ){ echo $_GET["leadto"]; } else{ echo $last_day_this_month; }  ?>" value="">
                              <input type="hidden" name="filter_val" id="filter_val" value="<?php if( isset( $_GET["leadStatus"] ) ){ echo $_GET["leadStatus"]; }else{ echo "";	} ?>" />
         ...
         <div class="portlet-body custom_card">
			<?php if( is_admin_or_manager() ){ ?>
				...
				<a href="<?php echo base_url("export/export_itinerary_fiter_data");?>" class="btn btn-danger pull-right export_btn"><i class="fa fa-file-excel"></i> Export</a>
				<a href="<?php echo site_url("itineraries"). "/?todayStatus={$todAy}&leadStatus=Qsent&quotation=true"; ?>" class="btn btn-success pull-right"><i class="fa fa-envelope"></i> Today Sent Quotation</a>
				<a href="<?php echo site_url("itineraries"). "/?todayStatus={$todAy}&leadStatus=QsentPast&quotation=true"; ?>" class="btn btn-info pull-right"><i class="fa fa-envelope"></i> Today Revised Quotation Sent</a>
				</div>
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="form-group">
               <a href="" class='btn btn-green disabledBtn' id="clone_current_iti" title='Clone Itinerary'><i class='fa fa-plus'></i> Clone Current Itinerary</a>
            </div>
         </div>
         <div class="modal-footer"></div>
      </div>
...
<script type="text/javascript">
   jQuery(document).ready(function($){
   	...
   	$(document).on("click",".export_btn", function(e){
   		...
   		var export_url = "<?php echo base_url('export/export_itinerary_fiter_data?filter='); ?>" + filter + "&d_from=" + d_from + "&end=" + end + "&todayStatus=" + todayStatus + "&quotation=" + quotation + "&agent_id=" + agent_id;
   		//redirect to export
