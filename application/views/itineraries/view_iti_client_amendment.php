...
<body>
	...
	<!--Section: Testimonials end-->
					...
					<!----end video player---->
                	<p class="comp-link">Sent by <a href="http://trackitinerary.com" target="_blank">trackitinerary.com</a></p>
                </div>
            </div>
                ...
                <ul class="nav nav-tabs" id="tab_lising" role="tablist">
                  ...
                  <div class="tab-content client-view">
					...
					<p><strong>Hi, <?php echo $customer_name; ?></strong> </p>
						<p><strong class="clrblue">GREETINGS FROM  Trackitinerary </strong></p>
			...
			<h2>DETAILED ITINERARY:</h2>
						...
						if( $count_day > 0 ){
							...
							<h4><span class="day1 <?php echo strtolower($tourData[$i]['tour_day']); ?>"><?php echo $tourData[$i]['tour_day']; ?> </span> <?php echo $tourData[$i]['tour_name'] . '( ' . $tourData[$i]['tour_distance'] . ' KMS )'; ?>  </h4>
									...
									<div id="collapse_<?php echo $count; ?>" class="panel-collapse collapse <?php if( $count ==1 ){ echo "in"; } ?>" role="tabpanel" aria-labelledby="iti_<?php echo $count; ?>">
									...
									<?php if( isset($tourData[$i]['hot_des'] ) && !empty( $tourData[$i]['hot_des'] ) ){
										...
										<div class="hot_destination_view"><div class="day_yellow"><i class="fa fa-map-marker" aria-hidden="true"></i>Attraction :</div><?php echo $hot_dest; ?></div>
									<?php }	?>
									</div>
							</div>
					...
					<?php $iti_temp_key = get_iti_temp_key( $iti->iti_id ); ?>
					<div class="cart">
						<div class="row">
