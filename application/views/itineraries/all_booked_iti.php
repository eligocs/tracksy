   ...
   <div class="page-content-wrapper">
      <div class="page-content">
         ...
         <div class="row margin-bottom-25 second_custom_card">
            ...
            <?php } ?>
            <div class="marginBottom <?php echo $hideClass; ?> col-md-7">
               <!--start filter section-->
               <form id="form-filter" class="form-horizontal">
                  <div class="actions custom_filter pull-left form-inline">
                     <strong>Filter: </strong>
                     <!--Calender-->
                     <input type="text" autocomplete ="off" class="form-control" id="daterange" name="dateRange" value="" required />
                     <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-default btn-primary custom_active"><input type="radio" name="filter" value="9" id="all"/>All</label>
                        <label class="btn btn-default btn-success custom_active"><input type="radio" name="filter" value="9" id="approved" />Booking Date</label>
                        <label title="Travel Date" class="btn btn-default btn-danger custom_active"><input type="radio" name="filter" value="travel_date" id="travel_date" />Travel Date</label>
                        <label title="Travel Date" class="btn btn-default btn-danger custom_active"><input type="radio" name="filter" value="travel_end_date" id="travel_end_date" />Checkout</label>
                     </div>
                     <!--End-->
                     ...
                     <input type="hidden" name="filter_val" id="filter_val" value="<?php if( isset( $_GET["leadStatus"] ) ){ echo $_GET["leadStatus"]; }else{ echo "9"; } ?>">
...
<script type="text/javascript">
   jQuery(document).ready(function($){
   	...
   	$(document).on("click",".export_btn", function(e){
   		...
   		var export_url = "<?php echo base_url('export/export_itinerary_fiter_data?filter='); ?>" + filter + "&d_from=" + d_from + "&end=" + end + "&todayStatus=" + todayStatus + "&agent_id=" + agent_id;
   		//redirect to export
