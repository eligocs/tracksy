		...
		<!--Show success message if hotel edit/add -->
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-users"></i>Customer Id: <span class='mehroon'><?php echo $iti->customer_id; ?></span>  Customer Name:  <span class='mehroon'><?php echo $customer_name; ?></span></div>
				...
				<div class="portlet-title">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<?php if( !$cab_booking_status ){ ?>
								<a href="<?php echo $add_cab_booking_link; ?>" class="btn btn-success pull-right" title="Book Cab"><i class="fa fa-plus"></i> Book New Cab</a>
							<?php } ?>	
						</div>
					</div>
					...
					<div class="table-responsive">
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<a href="<?php echo $add_cab_booking_link; ?>" class="" title="Book cab">Click here to book</a></td>
									</tr>	
								<?php } ?>
								</tbody>
							</table>
							...
							?>
								<button type="submit" <?php echo empty($continue_cab) ? "disabled" : ""; ?> data-iti_id="<?php echo $iti->iti_id; ?>" data-b_type="cab" data-booking_type="cab_booking_status" class="btn green uppercase confirm_booking_btn" title="All Volvo/Train/Flight Booking Done" >Confirm All Cab Booking Done</button>
								<div class='alert alert-danger'><strong>Note: </strong>If you confirm Cab booking you can't able to create new booking against this itinerary. You can't confirm booking if booking is on processing stage.</div></p>
							<?php } ?>	
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<?php if( !$vtf_booking_status ){ ?>
								<a href="<?php echo $add_vft_booking_link; ?>" class="btn btn-success pull-right" title="Book Hotel"><i class="fa fa-plus"></i> Book New</a>
							<?php } ?>	
						</div>
					<div class="portlet-body ">
						<div class="table-responsive">
							...
							<tbody>
								...
								<?php }else{ ?>
									<tr>
										...
										<?php if( !$vtf_booking_status ){ ?>
											<a href="<?php echo $add_vft_booking_link; ?>" class="badge badge-success" title="Book VTF">Click here to book</a>
										<?php } ?>	</td>
									</tr>	
								<?php } ?>
							</tbody>
						...
						<?php if( $vtf_booking_status ){
							...
							<button <?php echo empty($continue_vtf) ? "disabled" : ""; ?> type="submit" data-iti_id="<?php echo $iti->iti_id; ?>" data-b_type="vtf" data-booking_type="vtf_booking_status" class="btn green uppercase confirm_booking_btn" title="All Volvo/Train/Flight Booking Done" >Confirm All VTF Booking Done</button>
							<div class='alert alert-danger'><strong>Note: </strong>If you confirm vft booking you can't able to create new booking against this itinerary.You can't confirm booking if booking is on processing stage. </div></p>
						<?php } ?>	
					</div>
					</div>
					</div>
					...
					<div class="mt-element-step">
						<div class="row step-line">
							...
							<div class="col-md-3 mt-step-col <?php echo $vtf_class; ?>" title="Volvo/Train/Flight Booking Status. Green = done, Red = Pending" data-toggle="tooltip">
							...
							<div class="col-md-3 mt-step-col <?php echo $hotel_class; ?>" title="Hotel Booking Status. Green = done, Red = Pending" data-toggle="tooltip">
								<div class="mt-step-number bg-white">
									<i class="fa fa-bed"></i>
								</div>
							...
							<div class="col-md-3 mt-step-col <?php echo $cab_class; ?>" title="Cab Booking Status. Green = done, Red = Pending" data-toggle="tooltip">
								<div class="mt-step-number bg-white">
									<i class="fa fa-bus"></i>
								</div>
							...
							<div class="col-md-3 mt-step-col <?php echo $pay_class; ?>" title="Cab Booking Status. (Green >= 50 %, Red < 50%) Amount received" data-toggle="tooltip">
								<div class="mt-step-number bg-white">
									<i class="fa fa-inr"></i>
								</div>
	...
	$('.confirm_booking_btn').on('click', function () {
		...
		if( confirm('Are you sure to ' + _this_title + ' ? If you confirm hotel booking you cant able to create new booking against this itinerary') ){
			...
			$.ajax({
				...
				dataType: 'json',
				data: {iti_id: iti_id, type: booking_type, b_type: b_type },
				beforeSend: function(){
					LOADER.show();
					console.log("sending...");
				},
