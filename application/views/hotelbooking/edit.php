		...
		<div class="page-content">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-users"></i>Hotel Name: <strong><?php echo get_hotel_name($hotel_book->hotel_id); ?></strong></div>
				...
				<select required name="hotelcity" class="form-control city">
					...
					if($cities){
						foreach( $cities as $city ){ ?>
							<option value="<?php echo $city->id;?>" <?php if ($city->id == $hotel_book->city_id ) { ?> selected="selected" <?php } ?> > <?php echo $city->name ; ?></option>
						<?php }
					}
					?>
				</select>
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="clearfix"></div>
					<input type="text" class="form-control"  required name="invoice_id" value="<?php echo isset($hotel_book->invoice_id) ? $hotel_book->invoice_id : ""; ?>" >
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="clearfix"></div>
					<input type="text" id="total_tral" class="form-control"  required name="total_travellers" value="<?php echo isset($hotel_book->total_travellers) ? $hotel_book->total_travellers : ""; ?>">
				</div>
			</div>	
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="input-group input-daterange">
						<input readonly required type="text" class="form-control" name="check_in" value="<?php echo isset($hotel_book->check_in) ? $hotel_book->check_in : ""; ?>" id="check_in" >
						<span class="input-group-addon hotel_addon"> to </span>
						<input readonly required type="text" class="form-control" name="check_out" value="<?php echo isset($hotel_book->check_out) ? $hotel_book->check_out : ""; ?>" id="check_out" > 
					</div>
				</div>
			</div>
			<?php 
			...
			<div class="form-group">
				...
				<input readonly type="text" id="total_nights" class="form-control" value="<?php echo $total_nights; ?>">
			</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<textarea type="text" name="inclusion" placeholder="Inclusion" class="form-control"><?php echo isset($hotel_book->inclusion) ? $hotel_book->inclusion : ""; ?></textarea>	
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" required placeholder="Room Rate" name="room_rates" class="form-control room_rates clearfield price_input" value="<?php echo isset($hotel_book->room_cost) ? $hotel_book->room_cost : ""; ?>"/>
				</div> 
				</div>
				...
				<div class="form-group">
					...
					<input class="form-control total_room_rates clearfield" readonly required type="text" name="total_room_rates" value="<?php echo $total_room_cost_pernight; ?>" id="total_room_rates">	
					</div>	
				</div>	
				</div>	
				<div class="clearfix"></div>
				...
				<div class="form-group">
					<label >Total Rooms*: </label>
						...
						<label for="extra_bed_check"><input type="checkbox" <?php echo $extra_bed_check; ?> id="extra_bed_check" name="extra_bed_check" value="Yes"> Click Here to Add extra bed.</label>
						<label for="without_extra_bed_check"><input type="checkbox" <?php echo $without_extra_bed_check; ?>  id="without_extra_bed_check" value="Yes"> Click Here to Without extra bed.</label>
				</div>
				</div>
				<div class="col-md-9">
				...
				<div class="extra_bed_section" style="display: <?php echo $display; ?>"><!--extra bed cost section-->
					<div class="col-md-4">
				...
				<div class="col-md-3">
					...
					<input readonly class="form-control clearfield price_input" id="total_cost" type="number" name="total_cost" value="<?php echo isset($hotel_book->total_cost) ? $hotel_book->total_cost : ""; ?>">
				</div>
				<div class="clearfix"></div>	
...
jQuery(document).ready(function($){
	...
	$(document).on("blur", "#without_extra_bed_rate", function(){ 
		...
		var _this_val = parseFloat( $(this).val() );
		var withour_extra_bed = $(".withour_extra_bed").val() != "" ? parseFloat( $(".withour_extra_bed").val() ) : 0;
			...
			if (ajaxReq) {
				...
				success: function(res) {
					...
					if (res.status == true){
						...
						window.location.href = "<?php echo site_url("hotelbooking/view/");?>" + hotel_book_id +'/'+ iti_id; 
					}else{
