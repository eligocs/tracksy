...
<div class="page-container hotelbooking-page">
	<div class="page-content-wrapper">
		...
		<style>.error{bottom: -35px !important; }</style>
		...
		<?php if($hotel_book){ 
			...
			<div class="portlet box blue mb0">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-users"></i>Hotel Name: <strong><?php echo get_hotel_name($hotel_book->hotel_id); ?></strong> At <?php echo get_city_name($hotel_book->city_id); ?></div>
					
					<a class="btn btn-success" href="<?php echo site_url("hotelbooking"); ?>" title="Back">Back</a>
					<a class="btn btn-danger" target="_blank" style="margin: 3px;" href="<?php echo iti_view_single_link($hotel_book->iti_id); ?>" title="View Itinerary">View Itinerary</a>
				</div>
			</div>	
			<!-- SHOW HOTEL STATUS -->
			<div class="well well-sm">
				...
				<?php if( $hotel_book->booking_status == 9 ){ ?>
					...
					<h4>Hotel Booking Status</h4>
						...
						<div class="progress-bar progress-bar-striped  progress-bar-success active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:100%;    padding: 6px;">BOOKING CONFIRMED</div>
						</div>
						<?php if( $role == 99 || $role == 98 || $role == 97  ){ ?>
						<div class="close_iti">
							<a href="javascript: void(0)" id="update_closeStatus" data-id = "<?php echo $hotel_book->id; ?>" class="btn btn-danger" title="click to Cancel Booking"><i class="fa fa-close" aria-hidden="true"></i> Cancel Booking</a>	
						</div>
						<?php } ?>
					...
					<div class="col-md-6">
						<div class="form-group">
								<label class="control-label">Comment:</label>
									<blockquote>
										<div class="form-control" placeholder="Disabled" disabled="" ><?php echo $hotel_book->booking_note; ?></div>
									</blockquote> 
						</div>
					</div>
				...
				<?php }else if( $hotel_book->booking_status == 8 ){ ?>
					...
					<h4>Hotel Booking Status</h4>
					<div class="progress" style="height:30px;">
						<div class="progress-bar progress-bar-striped progress-bar-danger active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:100%; padding: 6px;">BOOKING DECLINED</div>
					</div>
					<?php if( $role == 99 || $role == 98 || $role == 97  ){ ?>
						<div>
							<a href="<?php echo base_url("hotelbooking/duplicate_hotel_booking/{$hotel_book->id}");?>" id="clone_hotel_booking" class="btn btn-success" title="click to clone Booking"><i class='fa fa-files-o' aria-hidden='true'></i> Duplicate Booking</a><!--clone booking btn-->
						</div>	
					<?php } ?>
					</div>	
				...
				<?php }else if( $hotel_book->booking_status == 7 ){ ?>
						<div class="col-md-6">
							<h4>Hotel Booking Status</h4>
							<div class="progress" style="height:30px;">
								<div class="progress-bar progress-bar-striped progress-bar-danger active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:100%; padding: 6px;">BOOKING CANCENLED</div>
							</div>
							<?php if( $role == 99 || $role == 98 || $role == 97  ){ ?>
							<div>
								<a href="<?php echo base_url("hotelbooking/duplicate_hotel_booking/{$hotel_book->id}");?>" id="clone_hotel_booking" class="btn btn-success" title="click to clone Booking"><i class='fa fa-files-o' aria-hidden='true'></i> Duplicate Booking</a></div><!--clone booking btn-->
							<?php } ?>
						</div>
						...
						<div class="form-group">
							<label class="control-label"> Cancellation Note By Agent:</label>
								<blockquote>
									<div class="form-control" placeholder="Disabled" disabled="" ><?php echo $hotel_book->booking_cancel_note; ?></div>
								</blockquote> 
						</div>
						...
						<div class="form-group">
							<label class="control-label">Cancellation Confirm Note By Hotel:</label>
								<blockquote>
									<div class="form-control" placeholder="Disabled" disabled="" > <?php echo !empty( $hotel_book->hotel_cancel_booking_note ) ?  $hotel_book->hotel_cancel_booking_note : "<span class='red'>Pending</span>"; ?></div>
								</blockquote> 
						</div>
					</div>
				<div class="clearfix"></div>
				...
				<div class="col-md-12">
					<h4>Hotel Booking Status</h4>
					<div class="progress" style="height:30px;">
						<div class="progress-bar progress-bar-striped  active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:90%; padding: 6px;">PROCESSING</div>
					</div>
				 <?php if( $role == 99 || $role == 98 || $role == 97  ){ ?>
					<div class="">
						<a href="javascript: void(0)" id="cancle_pre_booking" data-id = "<?php echo $hotel_book->id; ?>" class="btn btn-danger" title="click to Cancel Booking"><i class="fa fa-close" aria-hidden="true"></i> Cancel Booking</a>
			...
			<!-- END SHOW HOTEL STATUS -->
				...
				<div class="portlet-body">
					...
					<div class="clearfix"></div>
							...
							<div class=" col-md-12 table-responsive">	
								...
								<?php //if( $hotel_book->is_approved_by_gm == 2 && $hotel_book->room_cost_old_by_agent > 0 ){ ?>
									<tr>
										<td><div class="col-mdd-2 form_v_hotel_book green"><strong>Room Cost per/day: </strong></div></td>	
										<td><div class="col-mdd-2 form_v_hotel_book green"><strong><?php echo $hotel_book->room_cost; ?></strong></div></td>	
										
										<!--td><div class="col-mdd-2 form_v_hotel_book red"><strong>Old Room Cost per/day: </strong></div></td>	
										<td><div class="col-mdd-2 form_v_hotel_book red"><strong><?php //echo $hotel_book->room_cost_old_by_agent; ?></strong></div></td-->	
									</tr>
								<?php //} ?><!--End APPROVED BY GM SHOW OLD ROOM Cost-->
							<tr>
								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Client Name: </strong></div></td>	
								<td><div class="col-mdd-10 form_vr"><?php echo get_customer_name($hotel_book->customer_id); ?></div></td>
								<?php
								...
								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Number of Rooms</strong></div></td>

								<td><div class="col-mdd-10 form_vr"><?php echo $hotel_book->total_rooms . " " . get_roomcat_name($hotel_book->room_type); ?></div></td>	
							...
							<tr>
								...
								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Number of Guest</strong></div></td>		

								<td><div class="col-mdd-10 form_vr"><?php echo $total_tra; ?></div></td>

								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Check In Date</strong></div></td>				

								<td><div class="col-mdd-10 form_vr"><?php echo display_month_name($hotel_book->check_in); ?></div></td>					
							...
							<tr>
								...
								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Hotel Email:</strong></div></td>		

								<td><div class="col-mdd-10 form_vr"><?php echo $hotel_email; ?></div></td>			

								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Check Out Date</strong></div></td>				

								<td><div class="col-mdd-10 form_vr"><?php echo display_month_name($hotel_book->check_out); ?></div></td>			
							...
							<td><div class="col-mdd-2 form_v_hotel_book"><strong>Hotel Contact Number:</strong></div></td>		

							<td><div class="col-mdd-10 form_vr"><?php echo $hotel_contact; ?></div></td>

							<td><div class="col-mdd-2 form_v_hotel_book"><strong>Duration </strong></div></td>

								<td><div class="col-mdd-10 form_vr"><?php echo $duration; ?></div></td>	
					...
					<tr>
							<td><div class="col-mdd-2 form_v_hotel_book"><strong>Meal Plan</strong></div></td>

							<td><div class="col-mdd-10 form_vr"><?php echo $hotel_book->meal_plan ? get_meal_plan_name($hotel_book->meal_plan) : "No"; ?></div></td>

							

					

							<td><div class="col-mdd-2 form_v_hotel_book"><strong>Room Rate:</strong>(room rate*total rooms) </div></td>
							<td><div class="col-mdd-10 form_vr">INR. <?php echo $room_rate . " /-Per Night * " . $total_rooms . " = "." INR." . number_format($total_room_cost_pernight) ; ?></div></td>
							...
							<tr>
								...
								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Inclusion: </strong></div></td>

								<td><div class="col-mdd-10 form_vr"><?php echo $inc ; ?></div></td>

								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Extra Bed Cost:(bed cost*total bed) </strong></div></td>			

								<?php if( $extra_bed > 0 ){ ?>

									<td><div class="col-mdd-10 form_vr"><?php echo $extra_bed_cost . " /-Per Bed * " . $extra_bed . " = " . number_format($extra_bed_cost_per_night); ?></div>

									</td> 

								<?php }else{ ?>

									<td><div class="col-mdd-10 form_vr">-</div></td> 
					...
					<tr>			
						...
						<td><div class="col-mdd-2 form_v_hotel_book"><strong>Without Extra Bed Costs ( without bed cost*total without bed): </strong></div></td>	

						<td><div class="col-mdd-10 form_vr"><?php echo $hotel_book->without_extra_bed_cost . " * " . $w_extra_bed . " = " . number_format($without_extra_bed_cost); ?></div></td>						
					...
					<?php } ?>
							...
							<tr>
								...
								<td><div class="col-mdd-2 form_v_hotel_book"><strong>Total Nights Cost:</strong>(TRC+WBC+EBC)*TN</div></td>				

								<td><div class="col-mdd-10 form_vr">INR. <?php echo number_format($total_cost_rooms) . " * " . $nights; ?></div></td>		
					...
					<tr>			
						...
						<td><div class="col-mdd-2 form_v_hotel_book"><strong>Total Rooms Costs: </strong></div></td>	
					...
					<tr>
						...
						<td><div class="col-mdd-10 form_vr">INR. <?php echo  !empty($inclusion_cost) ? $inclusion_cost : 0; ?></div></td>		
					...
					<tr>
						...
						<td><div class="col-mdd-2 form_v_hotel_book"><strong>Hotel Tax: </strong></div></td>					

						<td><div class="col-mdd-10 form_vr">INR.  <?php echo  !empty($hotel_tax) ? $hotel_tax : 0; ?></div></td>			
					...
					<tr class="total-cost">
						...
						<td><div class="col-mdd-10 form_vr">INR. <?php echo $total_cost . " /-"; ?></div></td>		
					</tr>
				</table>
			</div>	
			
			<?php if( empty( $hotel_book->booking_status ) ){ ?>
				<div class="text-center"><a style="display:inline;" href="<?php echo site_url("hotelbooking/edit/{$hotel_book->id}/{$hotel_book->iti_id}"); ?>" class='btn btn-success' title="Update Hotel Booking Info"><i class='fa fa-pencil'></i> Update Booking</a></div>
				<hr>
			<?php } ?>
		...
		<div class="modal-body">
			...
			$hotel_emails = $hotel_info->hotel_email; ?>
				<div class="form-group">
				  ...
				  <input required type="text" readonly value="<?php echo $hotel_emails; ?>" class="form-control" id="email" placeholder="Enter customer email" >
				</div>
				<div class="form-group">
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
			...
			$hotel_emails = $hotel_info->hotel_email; ?>
				<div class="form-group">
				  <label for="email">Hotel Emails:</label>
				   <textarea required readonly class="form-control" id="email" name=""><?php echo $hotel_emails; ?></textarea>
				...
				<div class="form-group">
				  <label for="sub">Subject*:</label>
				  <input type="text" required class="form-control" id="sub" placeholder="Cancellation confirmation Mail" name="subject" value="" >
				</div>
				
				<div class="form-group">
				  <label for="sub">Comment*:</label>
				  <textarea required class="form-control" placeholder="Cancellation Comment" name="comment" ></textarea>
				</div>
				
				<input type="hidden" name="iti_id" value="<?php echo $hotel_book->iti_id; ?>">
				<input type="hidden" name="hotel_id" value="<?php echo $hotel_book->hotel_id; ?>">
				<input type="hidden" name="id" value="<?php echo $hotel_book->id; ?>">
				<button type="submit" id="sentIti_btn" class="btn btn-success">Send Cancellation Mail</button>
