...
.heading-label {background: #f1f1f1;    padding: 10px;    border: 1px solid #ececec;     margin-top: 0;}					
				...
				<form role="form" class="form-horizontal form-bordered" id="filter_frm">
					...
					<div class="form-group nl-input-field">
						<textarea required  maxlength="160" name="text_message" class="form-control"><?php echo $news->message; ?></textarea>					
					</div>
					...
					<?php } ?>	
						<div class="col-md-3">	
							<div class="margiv-top-10">
								<a href="javascript:void(0);" class="btn green uppercase get_marketing_users">Get Customers</button>
