		...
		<!--Show success message if hotel edit/add -->
			...
			<div class="portlet-body">
				...
				<table class="table table-condensed table-hover">	
					<tr>
						<td width="20%"><div class="col-mdd-2 form_vl"><strong>Marketing Category: </strong></div></td>	
						<td><div class="col-mdd-10 form_vr"><?php echo get_marking_cat_name($muser->cat_id); ?></div></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><div class="col-mdd-10 form_vr"><?php echo $muser->email_id; ?></div></td>
					</tr>	
					<tr>
						<td width="20%"><div class="col-mdd-2 form_vl"><strong>Contact Number: </strong></div></td>	
						<td><div class="col-mdd-10 form_vr"><?php echo $muser->contact_number; ?></div></td>
					</tr>	
					<tr>
						<td width="20%"><div class="col-mdd-2 form_vl"><strong>Whats App Number: </strong></div></td>	
						<td><div class="col-mdd-10 form_vr"><?php echo $muser->whats_app_number; ?></div></td>
					</tr>	
					<tr>
						<td width="20%"><div class="col-mdd-2 form_vl"><strong>Business Name: </strong></div></td>	
						<td><div class="col-mdd-10 form_vr"><?php echo $muser->company_name; ?></div></td>
					</tr>	
					<tr>
					...
					<tr>
						...
						<td><div class="col-mdd-10 form_vr"><?php echo $muser->place; ?></div></td>
					</tr>	
					<tr>
						<td width="20%"><div class="col-mdd-2 form_vl"><strong>Website: </strong></div></td>	
						<td><div class="col-mdd-10 form_vr"><?php echo $muser->website; ?></div></td>
					</tr>
				</table>	
			</div>	
			<!--Edit Button-->
