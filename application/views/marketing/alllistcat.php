		 ...
		 <!-- BEGIN SAMPLE TABLE PORTLET-->
			<div class="portlet box blue">
				<div class="portlet-title">
					...
					<a class="btn btn-success" href="<?php echo site_url("marketing/addcat"); ?>" title="add agent">Add Category</a>
				</div>
			</div>
						...
						<tbody>
							...
							if(!empty($row)){
								...
								<tr>
									...
									<td>
										<a title='edit' href=" <?php echo site_url("marketing/editcat/".$cat->id);?>" class="btn btn-success ajax_edit_cat_table" ><i class='fa fa-pencil'></i></a>
							...
							<tr>
								<td colspan="3" style="text-align:center;"> No Records Found Click here to <a href="<?php echo site_url("marketing/addcat")?>">add new category</a></td>
							<?php } ?>
							</tr>
						</tbody>
					</table>
