			...
			<form role="form" id="addTranspoter">
				<div class="row">
					...
					<div class="form-group">
						...
						<input type="text" required placeholder="Transporter Name" name="trans_name" class="form-control" value=""/> 
					</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
						<label class="control-label">Contact Number*:</label>
						<input type="number" required placeholder="Contact Number" name="trans_contact" class="form-control" value=""/> 
					</div>
					</div>
					<div class="col-md-4">
					<div class="form-group">
						<label class="control-label">Email Address*:</label>
						<input type="email" required placeholder="Transpoter Email" name="trans_email" class="form-control" value=""/> 
					</div>
					</div>
					...
					<div class="form-group">
						...
						<textarea placeholder="Transpoter address" name="trans_address" class="form-control"></textarea> 
					</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label">Select Vehicles*:</label><span style="font-size: 10px; font-weight: bold;"> Press CTRL key to select multiple vehicles.</span>
			...
			ajaxReq = $.ajax({
				...
				success: function(res) {
					if (res.status == true){
						...
						window.location.href = "<?php echo site_url("vehicles/transporterview/");?>" + res.tra_id; 
					}else{
