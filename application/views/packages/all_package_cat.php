	...
	<div class="page-content-wrapper">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<a class="btn btn-success" href="<?php echo site_url("packages/addcat"); ?>" title="add hotel">Add Package Category</a>
			</div>
		</div>	
...
jQuery(document).ready(function($){
	$(document).on("click", ".ajax_delete_package_cat", function(){
		...
		if (confirm("Are you sure?")) {
			$.ajax({
				url: "<?php echo base_url(); ?>" + "packages/update_del_status_package_cat?id=" + id,
				type:"GET",
				data:id,
				dataType: 'json',
				cache: false,
