...
<div class="page-content-wrapper sales_team_dashboard">
	...
	<div class="page-content">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="callCountBlock">
				<a class="dashboard-stat dashboard-stat-v2 blue" href="<?php echo site_url("itineraries") . "/?todayStatus={$today_date}&leadStatus=approved"; ?>">
					<div class="visual">
						<i class="fa fa-comments"></i>
					</div>
					<div class="details">
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="callCountBlock">
				<a class="dashboard-stat dashboard-stat-v2 blue" href="<?php echo site_url("itineraries") . "/?todayStatus={$this_month}&leadStatus=approved"; ?>">
					<div class="visual">
						<i class="fa fa-comments"></i>
					</div>
					<div class="details">
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="callCountBlock">
				<a class="dashboard-stat dashboard-stat-v2 blue" href="<?php echo site_url("payments"). "/?todayStatus={$this_month}&payStatus=advance_pending"; ?>">
					<div class="visual">
						<i class="fa fa-comments"></i>
					</div>
					<div class="details">
						<div class="number">
							<span data-counter="counterup" data-value="<?php echo isset($advance_payment_pending_count) ? $advance_payment_pending_count : 0; ?>">0</span>
						</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="callCountBlock">
				<a class="dashboard-stat dashboard-stat-v2 blue" href="<?php echo site_url("payments"). "/?todayStatus={$this_month}&payStatus=bal_pending"; ?>">
					<div class="visual">
						<i class="fa fa-comments"></i>
					</div>
					<div class="details">
						<div class="number">
							<span data-counter="counterup" data-value="<?php echo isset($balance_payment_pending_count) ? $balance_payment_pending_count : 0; ?>">0</span>
						</div>
			...
			<div class="col-lg-6 col-xs-12 col-sm-12">
				<div class="portlet light bordered">
					<div class="portlet-title tabbable-line">
						<div class="caption">
							<i class="icon-bubbles font-dark hide"></i>
							<span class="caption-subject font-dark bold uppercase">Latest Pending Vouchers</span>
						</div>
					</div>
					<div class="portlet-body">
						<div class="tab-content">
									...
									<table class="table table-hover d-table table-fixed">
										...
										<?php if( isset($pending_vouchers) && !empty($pending_vouchers) ) {
											...
											<tr>
												...
												<td><a class="btn btn-custom" target="_blank" href="<?php echo site_url("itineraries/view_iti/{$pen_voucher->iti_id}/{$pen_voucher->temp_key}"); ?>"> View</a></td>
											</tr>
											<?php 
												$dcnt++;
											} 
