            ...
            <div class="col-lg-6 col-xs-12 col-sm-12">
                <div class="portlet light bordered">
                    <div class="portlet-title" style="background: red;">
                        <div class="caption">
                            <i class="icon-equalizer font-dark hide"></i>
                            <span class="caption-subject font-dark bold uppercase">Hotels Pending Bookings
                                Quoations</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                                 ...
                                 foreach( $hotel_pending_booking as $booking ){ 
                                 	...
                                 	?>
                                        <tr class="">
                                            ...
                                            <td><a class="btn btn-custom" target="_blank"
                                                    href="<?php echo site_url("hotelbooking/view/{$booking->id}/{$booking->iti_id}"); ?>">
                                                    View</a> </td>
                                        </tr>
                                        <?php 
                                 $p_count1++;
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center">
                                                <div class="mt-comment-text"> <a class="btn btn-custom" target="_blank"
                                                        href="<?php echo $view_all_link; ?>"> View All</a> </div>
                                            </td>
                                        </tr>
                                        <?php }else{ ?>
                                        <tr>
                                 ...
                                 foreach( $cab_pending_booking as $booking ){ 
                                 	...
                                 	?>
                                        <tr class="">
                                            ...
                                            <td><?php echo $booking->total_cost; ?> /-</td>
                                            <td><a class="btn btn-custom" target="_blank"
                                                    href="<?php echo site_url("vehiclesbooking/viewbooking/{$booking->id}"); ?>">
                                                    View</a> </td>
                                        </tr>
                                        <?php 
                                 $p_count1++;
            ...
            <div class="col-lg-6 col-xs-12 col-sm-12">
                <div class="portlet light bordered">
                    <div class="portlet-title red_background">
                        <div class="caption">
                            <i class="icon-equalizer font-dark hide"></i>
                            <span class="caption-subject font-dark bold uppercase">Volvo/Train Pending Bookings
                                Quoations</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                                 ...
                                 foreach( $vtf_pending_booking as $booking ){ 
                                 	...
                                 	?>
                                        <tr class="">
                                            ...
                                            <td><?php echo $booking_date;?></td>
                                            <td><a class="btn btn-custom" target="_blank"
                                                    href="<?php echo site_url("vehiclesbooking/viewvehiclebooking/{$booking->id}/{$booking->iti_id}"); ?>">
                                                    View</a> </td>
                                        </tr>
                                        <?php 
                                 $p_count1++;
