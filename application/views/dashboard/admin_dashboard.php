                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="ratestab1">
                                            <table class="table table-hover d-table table-fixed">
                                                ...
                                                ?>
                                                        <tr>
                                                            <td colspan="5"><span class="lead_app arrow_bottom"><?php echo $a_forty_pkg->package_name; ?></span>
            ...
            <div class="month_section">
                <div class="portlet box blue">
                    <div class="portlet-title">
                        ...
                        <button type="button" data-target_id="month_full_stat" class="btn btn_blue_outline purple view_all_stat_btn pull-right" style="margin-top: 3px;">
