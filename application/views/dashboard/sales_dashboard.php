...
<div class="page-content-wrapper sales_team_dashboard">
    ...
    <div class="page-content">
                        ...
                        <div class="callCountBlock">
                            <a class="dashboard-stat dashboard-stat-v2 green"
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Call <br>Picked </div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="callCountBlock">
                            <a class="dashboard-stat dashboard-stat-v2 purple"
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Call <br>Not Picked </div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="callCountBlock">
                            <a class="dashboard-stat dashboard-stat-v2 blue"
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Declined <br>Leads </div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="callCountBlock">
                            <a class="dashboard-stat dashboard-stat-v2 blue"
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Working <br>Itineraries </div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="callCountBlock">
                            <a class="dashboard-stat dashboard-stat-v2 green"
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Approved <br>Itineraries </div>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="callCountBlock">
                            <a class="dashboard-stat dashboard-stat-v2 purple"
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Declined <br>Itineraries </div>
                                </div>
                            </a>
                        </div>
                    </div>
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-handshake-o" aria-hidden="true"></i> ON HOLD ITINERARIES / CHECKOUT
                </div>
            </div>
            <div class="portlet-body">
                        ...
                        <div class="panel">
                            <div class="panel-heading2">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab1primary" data-toggle="tab">REJECTED ITINERARIES BY
                                            SALES MANAGER</a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1primary">
                                        <table class="table table-hover d-table table-fixed">
                                            ...
                                            <tr>
                                                <td colspan="4"><span
                                                        class="lead_app arrow_bottom"><?php echo $onhold->package_name; ?></span><?php echo $iti_type; ?>
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="row dashboard-tables-all-info">
                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-heading2">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#tab4" data-toggle="tab">TOTAL LEADS OF THE DAY</a>
                                        </li>
